 ...
 * $Revision: 18 $
 * $Date: 16/03/02 9:56a $
 * @brief    NM1530 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NM1530 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
/**
  ...
  * \li First release to support NM1530.
*/
...
typedef enum IRQn
{
    ...
    MDU_IRQn                  = 17,       /*!< Motor Drive Unit Interrupt                             */
    ...
    QEI0_IRQn                 = 26,       /*!< QEI0 Interrupt                                         */
    QEI1_IRQn                 = 27,       /*!< QEI1 Interrupt                                         */
...
#include "system_NM1530.h"        /* NM1530 System                                          */
...
#define CAN_STATUS_LEC_Msk         (0x7ul << CAN_STATUS_LEC_Pos)        /*!< CAN STATUS: LEC Mask       */
...
typedef struct
{
     ...
     * |        |          |Set by "Power-down wake-up event", it indicates that resume from Power-down mode. Write 1 to clear the bit to 0.
     ...
     * |[18]    |MDU_EN    |MDU Clock Enable Control
     * |        |          |0 = MDU clock Disabled.
     * |        |          |1 = MDU clock Enabled.
     ...
     * |[24]    |CAN_EN    |CAN Bus Controller Clock Enable Control
     ...
     * |[30]    |QEI0_EN   |QEI0 Clock Enable Control
     * |        |          |0 = QEI0 clock Disabled.
     * |        |          |1 = QEI0 clock Enabled.
     * |[31]    |QEI1_EN   |QEI1 Clock Enable Control
     ...
     * |[5]     |DIV1      |Frequency Divider Divide 1 Enable
...
#define CLK_APBCLK_QEI1_EN_Pos               31                                   /*!< CLK_T::APBCLK: QEI1_EN Position */
#define CLK_APBCLK_QEI1_EN_Msk               (1ul << CLK_APBCLK_QEI1_EN_Pos)      /*!< CLK_T::APBCLK: QEI1_EN Mask */

#define CLK_APBCLK_QEI0_EN_Pos               30                                   /*!< CLK_T::APBCLK: QEI0_EN Position */
#define CLK_APBCLK_QEI0_EN_Msk               (1ul << CLK_APBCLK_QEI0_EN_Pos)      /*!< CLK_T::APBCLK: QEI0_EN Mask */
...
#define CLK_APBCLK_CAN_EN_Pos                24                                   /*!< CLK_T::APBCLK: CAN_EN Position */
#define CLK_APBCLK_CAN_EN_Msk                (1ul << CLK_APBCLK_CAN_EN_Pos)       /*!< CLK_T::APBCLK: CAN_EN Mask */
...
#define CLK_APBCLK_MDU_EN_Pos                18                                   /*!< CLK_T::APBCLK: MDU_EN Position */
#define CLK_APBCLK_MDU_EN_Msk                (1ul << CLK_APBCLK_MDU_EN_Pos)       /*!< CLK_T::APBCLK: MDU_EN Mask */
...
typedef struct
{
     ...
     * |[30]     |AUTOLD    |Auto Load Enable Bit
     * |         |          |0 = PWM duty registers PWMx0~PWMx4 are updated by software.
     * |         |          |1 = PWM duty registers PWMx0~PWMx4 are auto-load from motor drive unit (MDU) when
     * |         |          |MDU update a set of new duty values for PWM unit.
...
typedef struct
{
     ...
     * |        |          |The NuMicro NM1530 Series has a maximum 32Kx32 (128 KB) of embedded Flash,
...
typedef struct
{
    ...
    /**
     * @var GPIO_T::PMD
     * Offset: 0x00  GPIO Port I/O Mode Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
/*---------------------- Motor Drive Unit -------------------------*/
/**
    @addtogroup MDU Motor Drive Unit(MDU)
    Memory Mapped Structure for MDU Controller
@{ */
...
typedef struct
{
    ...
    /**
     * @var MDUG_T::MDUSCON
     * Offset: 0x00  MDU Switch Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |MDUS      |MDU Switch Control Register
     * |        |          |0 = MDU is controlled by MDU0 control register.
     * |        |          |1 = MDU is controlled by MDU1 control register.
     * @var MDUG_T::MDUSSTS
     * Offset: 0x04  MDU Switch Status
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |MDU0BUSY  |MDU0 Busy Register
     * |        |          |0 = MDU0 is idle.
     * |        |          |1 = MDU0 is busy.
     * |[1]     |MDU1BUSY  |MDU1 Busy Register
     * |        |          |0 = MDU1 is idle.
     * |        |          |1 = MDU1 is busy.
     * |[2]     |MDUACT    |MDU Active Set
     * |        |          |0 = MDU0 is active.
     * |        |          |1 = MDU1 is active.
     */

    __IO uint32_t MDUSCON;       /* Offset: 0x00  MDU Switch Control                                                 */
    __IO uint32_t MDUSSTS;       /* Offset: 0x04  MDU Switch Status                                                  */
...
/**
    @addtogroup MDUG_CONST MDUG Bit Field Definition
    Constant Definitions for MDUG Controller
@{ */

#define MDUG_MDUSCON_MDUS_Pos            (0)                                               /*!< MDUG_T::MDUSCON: MDUS Position            */
#define MDUG_MDUSCON_MDUS_Msk            (0x1ul << MDUG_MDUSCON_MDUS_Pos)                  /*!< MDUG_T::MDUSCON: MDUS Mask                */

#define MDUG_MDUSSTS_MDU0BUSY_Pos        (0)                                               /*!< MDUG_T::MDUSSTS: MDU0BUSY Position        */
#define MDUG_MDUSSTS_MDU0BUSY_Msk        (0x1ul << MDUG_MDUSSTS_MDU0BUSY_Pos)              /*!< MDUG_T::MDUSSTS: MDU0BUSY Mask            */

#define MDUG_MDUSSTS_MDU1BUSY_Pos        (1)                                               /*!< MDUG_T::MDUSSTS: MDU1BUSY Position        */
#define MDUG_MDUSSTS_MDU1BUSY_Msk        (0x1ul << MDUG_MDUSSTS_MDU1BUSY_Pos)              /*!< MDUG_T::MDUSSTS: MDU1BUSY Mask            */

#define MDUG_MDUSSTS_MDUACT_Pos          (2)                                               /*!< MDUG_T::MDUSSTS: MDUACT Position          */
#define MDUG_MDUSSTS_MDUACT_Msk          (0x1ul << MDUG_MDUSSTS_MDUACT_Pos)                /*!< MDUG_T::MDUSSTS: MDUACT Mask              */
...
typedef struct
{
    ...
    /**
     * @var MDU_T::Ia
     * Offset: 0x00  Phase A Current Register, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Motor Phase Current Data Register
     ...
     * @var MDU_T::Ib
     * Offset: 0x04  Phase B Current Register, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Motor Phase Current Data Register
     ...
     * |        |          |The MCU must update registers Ia, Ib and Ic in the beginning of a FOC process flow.
     * @var MDU_T::Ic
     * Offset: 0x08  Phase C Current Register, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Motor Phase Current Data Register
     ...
     * |        |          |The MCU must update registers Ia, Ib and Ic in the beginning of a FOC process flow.
     * @var MDU_T::Ialfa
     * Offset: 0x0C  Clarke Transformation Output Register, the Current Along alpha-axis
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Clarke Transformation Output Data Register
     * |        |          |This data content is produced by Clarke Transformation function block and stored in Q-15
     * |        |          |format.
     * |        |          |It is also writable by software.
     * @var MDU_T::Ibeta
     * Offset: 0x10  Clarke Transformation Output Register, the Current Along beta-axis
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Clarke Transformation Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::SIN
     * Offset: 0x14  Trigonometric Value of SIN Register, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Trigonometric Value Of SIN / COS Data Register
     * |        |          |The trigonometric value of SIN and COS, which is represented in Q-15 format, must be preset
     * |        |          |before operating Park and inverse Park transformation
     * @var MDU_T::COS
     * Offset: 0x18  Trigonometric Value of COS Register, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Trigonometric Value Of SIN / COS Data Register
     ...
     * |        |          |before operating Park and inverse Park transformation
     * @var MDU_T::Id
     * Offset: 0x1C  Park Transformation Output Register, the Current Along d-axis.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Park Transformation Output Data Register
     * |        |          |This data content is produced by Park Transformation function block and stored in Q-15
     * |        |          |format.
     * |        |          |It is also writable by software.
     * @var MDU_T::Iq
     * Offset: 0x20  Park Transformation Output Register, the Current Along q-axis.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Park Transformation Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::Id_CMD
     * Offset: 0x24  PI_d Controller Command Input Register, Represented in Q-15 Format.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |CMD       |PI Controller Command Input Register
     * |        |          |The register content stands for the PI controller command input. It must be normalized in
     * |        |          |Q-15 format.
     * @var MDU_T::Iq_CMD
     * Offset: 0x28  PI_q Controller Command Input Register, Represented in Q-15 Format.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |CMD       |PI Controller Command Input Register
     ...
     * |        |          |Q-15 format.
     * @var MDU_T::KP_d
     * Offset: 0x2C  Parameter KP for PI_d Controller, Represented in 18-bit I2Q-15 (Q2.15) Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[17:0]  |DATA      |PI Controller Parameter Register
     * |        |          |The KP_d and KP_q stand for the proportional parameter of PI controller, the KI_d and KI_q
     * |        |          |stand for the integral parameter of PI controller.
     * |        |          |The register data value must be stored in Q-15 format.
     * @var MDU_T::KI_d
     * Offset: 0x30  Parameter KI for PI_d Controller, Represented in 18-bit I2Q-15 (Q2.15) Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[17:0]  |DATA      |PI Controller Parameter Register
     ...
     * |        |          |The register data value must be stored in Q-15 format.
     * @var MDU_T::KP_q
     * Offset: 0x34  Parameter KP for PI_q Controller, Represented in 18-bit I2Q-15 (Q2.15) Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[17:0]  |DATA      |PI Controller Parameter Register
     ...
     * |        |          |The register data value must be stored in Q-15 format.
     * @var MDU_T::KI_q
     * Offset: 0x38  Parameter KI for PI_q Controller, Represented in 18-bit I2Q-15 (Q2.15) Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[17:0]  |DATA      |PI Controller Parameter Register
     ...
     * |        |          |The register data value must be stored in Q-15 format.
     * @var MDU_T::PI_dFW
     * Offset: 0x3C  PI_d Controller Feed Forward Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |PI Controller Feed Forward Data Register
     * |        |          |Software presets the feed forward value of the PI controller in this register.
     * @var MDU_T::PI_qFW
     * Offset: 0x40  PI_q Controller Feed Forward Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |PI Controller Feed Forward Data Register
     * |        |          |Software presets the feed forward value of the PI controller in this register.
     * @var MDU_T::UI_d
     * Offset: 0x44  D-axis I Control Output Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |DATA      |Integral Controller Output Data Register
     * |        |          |The PI function block content I (Integral) controller and P (Proportional) controller, and I
     * |        |          |controller output data will be used as the next PI control flow.
     * |        |          |Here is the register to save the output data of I controller and will update when PI
     * |        |          |controller finished once operation.
     * |        |          |Here, the register content is a Q-15 format value (PI_Q20_EN = 0) or Q-20 format
     * |        |          |value (PI_Q20_EN = 1).
     * @var MDU_T::UI_q
     * Offset: 0x48  Q-axis I Control Output Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |DATA      |Integral Controller Output Data Register
     ...
     * |        |          |value (PI_Q20_EN = 1).
     * @var MDU_T::Vd
     * Offset: 0x4C  PI_d Controller Output of d-axis, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |PI Controller Output Data Register (Inverse Park Transformation Input)
     * |        |          |This data content is produced by PI controller function block and stored in Q-15 format.
     * |        |          |It is also writable by software.
     * @var MDU_T::Vq
     * Offset: 0x50  PI_q Controller Output of q-axis, Represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |PI Controller Output Data Register (Inverse Park Transformation Input)
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::Valfa
     * Offset: 0x54  Inverse Park Transformation Output, the Voltage Along the alpha-axis
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Park Transformation Output Data Register
     * |        |          |This data content is produced by inverse Park Transformation function block and stored in
     * |        |          |Q-15 format.
     * |        |          |It is also writable by software.
     * @var MDU_T::Vbeta
     * Offset: 0x58  Inverse Park Transformation Output, the Voltage Along the beta-axis
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Park Transformation Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::Vref1
     * Offset: 0x5C  Inverse Clarke Transformation Output Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Clarke Transformation Output Data Register
     * |        |          |This data content is produced by inverse Clarke Transformation function block and stored in
     * |        |          |Q-15 format.
     * |        |          |It is also writable by software.
     * @var MDU_T::Vref2
     * Offset: 0x60  Inverse Clarke Transformation Output Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Clarke Transformation Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::Vref3
     * Offset: 0x64  Inverse Clarke Transformation Output Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Clarke Transformation Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::SVPDATA0
     * Offset: 0x68  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Taon time)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |SVPWM Output Data Register
     * |        |          |This data content is produced by SVPWM function block and stored in Q-15 format.
     * |        |          |It is also writable by software.
     * @var MDU_T::SVPDATA2
     * Offset: 0x6C  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Tbon time)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |SVPWM Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::SVPDATA4
     * Offset: 0x70  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Tcon time)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |SVPWM Output Data Register
     ...
     * |        |          |It is also writable by software.
     * @var MDU_T::SVPDATA0N
     * Offset: 0x74  An unsigned16-bit data Normalizes SVPDATA0 to PWMNORM and within the limit between PWMMAX and PWMMIN
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Normalized SVPDATA Register
     * |        |          |The SVPWM function block will normalizes the value of SVP0/2/4 to the range between 0000h
     * |        |          |and the value of PWMNORM and limit the PWM duty value within PWMMAX and PWMMIN.
     * |        |          |If SVPWM function block auto mode is active, each new SVPDATA0N/2N/4N will be reload to PWM
     * |        |          |unit 0 duty registers PWM0/2/4 after SVPWM operation is completed if PWMRUN and LOAD bits
     * |        |          |are enabled in PWM unit 0.
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::SVPDATA2N
     * Offset: 0x78  An unsigned 16-bit data Normalizes SVPDATA2 to PWMNORM and within the limit between PWMMAX and PWMMIN
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Normalized SVPDATA Register
     ...
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::SVPDATA4N
     * Offset: 0x7C  An unsigned 16-bit data Normalizes SVPDATA4 to PWMNORM and within the limit between PWMMAX and PWMMIN
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Normalized SVPDATA Register
     ...
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::MDUCON
     * Offset: 0x80  Motor Driver Unit Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CKSTR     |Clarke Transformation Start Bit (Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding Clarke Transformation and it is automatically
     * |        |          |cleared when the transform process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[1]     |PKSTR     |Park Transformation Start Bit (Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding Park Transformation and it is automatically
     * |        |          |cleared when the transform process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[2]     |PIDSTR    |D-Axis PI Controller Start Bit
     * |        |          |(Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding D-axis PI Control and it is automatically
     * |        |          |cleared when the process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[3]     |PIQSTR    |Q-Axis PI Controller Start Bit
     * |        |          |(Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding Q-axis PI Control and it is automatically
     * |        |          |cleared when the process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[4]     |INVPKSTR  |Inverse Park Transformation Start Bit (Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding Inverse Park Transformation and it is
     * |        |          |automatically cleared when the transform process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[5]     |INVCKSTR  |Inverse Clarke Transformation Start Bit (Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding Inverse Clarke Transformation and it is
     * |        |          |automatically cleared when the transform process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[6]     |SVPWMSTR  |SVPWM Start Bit (Write Only, Read 0)
     * |        |          |Setting this bit to high will start proceeding SVPWM timing calculating and it is
     * |        |          |automatically cleared when the process is completed by hardware.
     * |        |          |Writing it to 0 will stop and reset the function bloc.
     * |        |          |0 = No action.
     * |        |          |1 = Start the process.
     * |[9]     |PKAUTO    |Park Transformation Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the current function block is allowed to accept the previous
     * |        |          |start trigger and will trigger the start bit of the next function block after current
     * |        |          |function is complete.
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[10]    |PIDAUTO   |D-Axis PI Controller Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the current function block is allowed to accept the previous
     * |        |          |start trigger and will trigger the start bit of the next function block after current
     * |        |          |function is complete.
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[11]    |PIQAUTO   |D-Axis PI Controller Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the current function block is allowed to accept the previous
     * |        |          |start trigger and will trigger the start bit of the next function block after current
     * |        |          |function is complete.
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[12]    |INVPKAUTO |Inverse Park Transformation Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the current function block is allowed to accept the previous
     * |        |          |start trigger and will trigger the start bit of the next function block after current
     * |        |          |function is complete.
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[13]    |INVCKAUTO |Inverse Clarke Transformation Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the current function block is allowed to accept the previous
     * |        |          |start trigger and will trigger the start bit of the next function block after current
     * |        |          |function is complete.
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[14]    |SVPWMAUTO |SVPWM Auto-Mode Enable Bit
     * |        |          |Setting this bit will enable auto-mode of the function block.
     * |        |          |If the auto-mode is active, the SVPWM function block is allowed to accept the start trigger
     * |        |          |from Inverse Clarke block and SVPWM function proceeds completed, it will automatically
     * |        |          |update the duty registers in PWM unit0 and set the reload bit (LOAD).
     * |        |          |0 = Auto-mode Disabled.
     * |        |          |1 = Auto-mode Enabled.
     * |[16]    |ATCLRFG   |Auto-Clear Flag Control Bit
     * |        |          |When this bit is set to high, the complete flag of each function block in auto-mode is
     * |        |          |cleared automatically after SVPWM function block has updated PWM duty registers.
     * |        |          |The auto-clear flag function helps the FOC control flow runs smoothly without the need of
     * |        |          |software clearing flag.
     * |        |          |0 = Auto-clear flag function Disabled.
     * |        |          |1 = Auto-clear flag function Enabled.
     * |[17]    |SVPWM_DIS |SVPWM Block Function Disable Bit
     * |        |          |0 = SVPWM function block produces the Space Vector PWM timing for PWM duty registers.
     * |        |          |1 = SVPWM operation Disabled.
     * |[18]    |SVPWM_COM |SVPWM Value Complement Enable
     * |        |          |0 = SVPWM value is normal.
     * |        |          |1 = SVPWM value is complement.
     * |[19]    |SVPWM_X2  |SVPWM Taon Double Value Enable
     * |        |          |0 = SVPWM Taon is normal value.
     * |        |          |1 = SVPWM Taon is double value.
     * |[20]    |PI_Q20_EN |PI Controller Q20 Format Enable Bit
     * |        |          |0 = PI controller Q20 format Disabled.
     * |        |          |1 = PI controller Q20 format Enabled.
     * |[24]    |CK_IE     |Clark Block Interrupt Enable Bit
     * |        |          |0 = Clark block interrupt Disabled.
     * |        |          |1 = Clark block interrupt Enabled.
     * |[25]    |PK_IE     |Park Block Interrupt Enable Bit
     * |        |          |0 = Park block interrupt Disabled.
     * |        |          |1 = Park block interrupt Enabled.
     * |[26]    |PID_IE    |D-Axis PI Block Interrupt Enable Bit
     * |        |          |0 = D-axis PI controller block interrupt Disabled.
     * |        |          |1 = D-axis PI controller block interrupt Enabled.
     * |[27]    |PIQ_IE    |Q-Axis PI Block Interrupt Enable Bit
     * |        |          |0 = Q-axis PI controller block interrupt Disabled.
     * |        |          |1 = Q-axis PI controller block interrupt Enabled.
     * |[28]    |INVPK_IE  |Inv-Park Block Interrupt Enable Bit
     * |        |          |0 = Inv-Park block interrupt Disabled.
     * |        |          |1 = Inv-Park block interrupt Enabled.
     * |[29]    |INVCK_IE  |Inv-Clark Block Interrupt Enable Bit
     * |        |          |0 = Inv-Clark block interrupt Disabled.
     * |        |          |1 = Inv-Clark block interrupt Enabled.
     * |[30]    |SVPWM_IE  |Clark Block Interrupt Enable Bit
     * |        |          |0 = SVPWM block interrupt Disabled.
     * |        |          |1 = SVPWM block interrupt Enabled.
     * |        |          |Interrupt will generate if MDUINT_EN and SVPWM_IE is set to 1 and SVPWMCPF is set.
     * |[31]    |MDU_IE    |MDU Interrupt Enable Bit
     * |        |          |0 = MDU interrupt Disabled.
     * |        |          |1 = MDU interrupt Enabled.
     * @var MDU_T::MDUSTS
     * Offset: 0x84  Motor Driver Unit Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CKCPF     |Clarke Transformation Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and CKAUTO (Auto-mode
     * |        |          |enable bit) are set to high, the complete flag is cleared automatically after SVPWM function
     * |        |          |block has set PWM LOAD bit to high.
     * |[1]     |PKCPF     |Park Transformation Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and PKAUTO (Auto-mode
     * |        |          |enable bit) are set to high, the complete flag is cleared automatically after SVPWM function
     * |        |          |block has set PWM LOAD bit to high.
     * |[2]     |PI_qCPF   |PI_Q Controller Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and PI_qAUTO (Auto-mode
     * |        |          |enable bit) are set to high, the complete flag is cleared automatically after SVPWM function
     * |        |          |block has set PWM LOAD bit to high.
     * |[3]     |PI_dCPF   |PI_D Controller Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and PI_dAUTO (Auto-mode
     * |        |          |enable bit) are set to high, the complete flag is cleared automatically after SVPWM function
     * |        |          |block has set PWM LOAD bit to high.
     * |[4]     |INVPKCPF  |Inverse Park Transformation Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and INVPKAUTO
     * |        |          |(Auto-mode enable bit) are set to high, the complete flag is cleared automatically after
     * |        |          |SVPWM function block has set PWM LOAD bit to high.
     * |[5]     |INVCKCPF  |Inverse Clarke Transformation Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and INVCKAUTO
     * |        |          |(Auto-mode enable bit) are set to high, the complete flag is cleared automatically after
     * |        |          |SVPWM function block has set PWM LOAD bit to high.
     * |[6]     |SVPWMCPF  |SVPWM Complete Flag
     * |        |          |When the function block completes the process, the corresponding complete flag will be set
     * |        |          |by hardware.
     * |        |          |This flag can be cleared by a writing one to itself.
     * |        |          |Note: If both the control bits ATCLRFG (Auto-clear flag control bit) and SVPWMAUTO
     * |        |          |(Auto-mode enable bit) are set to high, the complete flag is cleared automatically after
     * |        |          |SVPWM function block has set PWM LOAD bit to high.
     * |[10:8]  |ZONE      |Zone Number Indicator
     * |        |          |A 360 degree space is equally divided into six zones where each zone is with 60 degree
     * |        |          |space.
     * |        |          |The SVPWM function block will internally produce the zone number during the operation which
     * |        |          |indicates the which zone the motor electric angle stays in the moment.
     * @var MDU_T::PI_dMAX
     * Offset: 0x100  Maximum limit value of PI_d Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MAX       |Maximum Limit Of PI Controller And I Controller Output
     * |        |          |The 16-bit value represented in Q-15 format limits the maximum value of the PI controller
     * |        |          |and I controller output.
     * @var MDU_T::PI_dMIN
     * Offset: 0x104  Minimum limit value of PI_d Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MIN       |Minimum Limit Of PI Controller And I Controller Output
     * |        |          |The 16-bit value represented in Q-15 format limits the minimum value of the PI controller
     * |        |          |and I controller output.
     * @var MDU_T::PI_qMAX
     * Offset: 0x108  Maximum limit value of PI_q Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MAX       |Maximum Limit Of PI Controller And I Controller Output
     ...
     * |        |          |and I controller output.
     * @var MDU_T::PI_qMIN
     * Offset: 0x10C  Minimum limit value of PI_q Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MIN       |Minimum Limit Of PI Controller And I Controller Output
     ...
     * |        |          |and I controller output.
     * @var MDU_T::I_dMAX
     * Offset: 0x110  Maximum limit value of integral_d Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |MAX       |Maximum Limit Of PI Controller And I Controller Output
     * |        |          |The 16-bit value represented in Q-15 format limits the maximum value of the integral
     * |        |          |controller output.
     * |        |          |Here, the register content is a Q-15 format value (PI_Q20_EN = 0) or Q-20 format
     * |        |          |value (PI_Q20_EN = 1).
     * @var MDU_T::I_dMIN
     * Offset: 0x114  Minimum limit value of integral_d Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |MIN       |Minimum Limit Of PI Controller And I Controller Output
     * |        |          |The 16-bit value represented in Q-15 format limits the minimum value of the integral
     * |        |          |controller output.
     * @var MDU_T::I_qMAX
     * Offset: 0x118  Maximum limit value of integral_q Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |MAX       |Maximum Limit Of PI Controller And I Controller Output
     ...
     * |        |          |value (PI_Q20_EN = 1).
     * @var MDU_T::I_qMIN
     * Offset: 0x11C  Minimum limit value of integral_q Controller in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[20:0]  |MIN       |Minimum Limit Of PI Controller And I Controller Output
     ...
     * |        |          |controller output.
     * @var MDU_T::Vd_In
     * Offset: 0x120  Inverse Park Transformation Input of d_axis represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Park Transformation Input Data (Read Only)
     * |        |          |This data content is produced by the PI controller with maximum and minimum limit operation
     * |        |          |and stored in Q-15 format.
     * |        |          |It is a read only register.
     * @var MDU_T::Vq_In
     * Offset: 0x124  Inverse Park Transformation Input of q_axis represented in Q-15 Format
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |DATA      |Inverse Park Transformation Input Data (Read Only)
     ...
     * |        |          |It is a read only register.
     * @var MDU_T::PWMNORM
     * Offset: 0x128  An Unsigned 16-bit PWM Normalization Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |PWMNORM   |PWM Normalization Data
     * |        |          |The SVPWM function block will normalize the value of SVP0/2/4 to the range between 0000h and
     * |        |          |the value of PWMNORM and limit the PWM duty value within PWMMAX and PWMMIN.
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::PWMMAX
     * Offset: 0x12C  An unsigned 16-bit Maximum Limit Value of SVPWM Output
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |PWMMAX    |Maximum Limit Of SVPWM Output Data Register
     * |        |          |The SVPWM function block will normalizes the value of SVP0/2/4 to the range between 0000h
     * |        |          |and the value of PWMNORM and limit the PWM duty value within PWMMAX and PWMMIN.
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::PWMMIN
     * Offset: 0x130  An unsigned 16-bit Minimum Limit Value of SVPWM Output
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |PWMMIN    |Maximum Limit Of SVPWM Output Data Register
     * |        |          |The SVPWM function block will normalize the value of SVP0/2/4 to the range between 0000h and
     * |        |          |the value of PWMNORM and limit the PWM duty value within PWMMAX and PWMMIN.
     * |        |          |Here, the register content is a 16-bit unsigned integer.
     * @var MDU_T::Id_Err
     * Offset: 0x134  Error of Id current = Id_CMD - Id; Read only
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * @var MDU_T::Iq_Err
     * Offset: 0x138  Error of Id current = Iq_CMD - Iq; Read only.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     */

    __IO uint32_t Ia;            /* Offset: 0x00  Phase A Current Register, Represented in Q-15 Format               */
    __IO uint32_t Ib;            /* Offset: 0x04  Phase B Current Register, Represented in Q-15 Format               */
    __IO uint32_t Ic;            /* Offset: 0x08  Phase C Current Register, Represented in Q-15 Format               */
    __IO uint32_t Ialfa;         /* Offset: 0x0C  Clarke Transformation Output Register, the Current Along alpha-axis */
    __IO uint32_t Ibeta;         /* Offset: 0x10  Clarke Transformation Output Register, the Current Along beta-axis */
    __IO uint32_t SIN;           /* Offset: 0x14  Trigonometric Value of SIN Register, Represented in Q-15 Format    */
    __IO uint32_t COS;           /* Offset: 0x18  Trigonometric Value of COS Register, Represented in Q-15 Format    */
    __IO uint32_t Id;            /* Offset: 0x1C  Park Transformation Output Register, the Current Along d-axis.     */
    __IO uint32_t Iq;            /* Offset: 0x20  Park Transformation Output Register, the Current Along q-axis.     */
    __IO uint32_t Id_CMD;        /* Offset: 0x24  PI_d Controller Command Input Register, Represented in Q-15 Format. */
    __IO uint32_t Iq_CMD;        /* Offset: 0x28  PI_q Controller Command Input Register, Represented in Q-15 Format. */
    __IO uint32_t KP_d;          /* Offset: 0x2C  Parameter KP for PI_d Controller, Represented in 18-bit I2Q-15 (Q2.15) Format */
    __IO uint32_t KI_d;          /* Offset: 0x30  Parameter KI for PI_d Controller, Represented in 18-bit I2Q-15 (Q2.15) Format */
    __IO uint32_t KP_q;          /* Offset: 0x34  Parameter KP for PI_q Controller, Represented in 18-bit I2Q-15 (Q2.15) Format */
    __IO uint32_t KI_q;          /* Offset: 0x38  Parameter KI for PI_q Controller, Represented in 18-bit I2Q-15 (Q2.15) Format */
    __IO uint32_t PI_dFW;        /* Offset: 0x3C  PI_d Controller Feed Forward Data Register                         */
    __IO uint32_t PI_qFW;        /* Offset: 0x40  PI_q Controller Feed Forward Data Register                         */
    __IO uint32_t UI_d;          /* Offset: 0x44  D-axis I Control Output Data Register                              */
    __IO uint32_t UI_q;          /* Offset: 0x48  Q-axis I Control Output Data Register                              */
    __IO uint32_t Vd;            /* Offset: 0x4C  PI_d Controller Output of d-axis, Represented in Q-15 Format       */
    __IO uint32_t Vq;            /* Offset: 0x50  PI_q Controller Output of q-axis, Represented in Q-15 Format       */
    __IO uint32_t Valfa;         /* Offset: 0x54  Inverse Park Transformation Output, the Voltage Along the alpha-axis */
    __IO uint32_t Vbeta;         /* Offset: 0x58  Inverse Park Transformation Output, the Voltage Along the beta-axis */
    __IO uint32_t Vref1;         /* Offset: 0x5C  Inverse Clarke Transformation Output Register                      */
    __IO uint32_t Vref2;         /* Offset: 0x60  Inverse Clarke Transformation Output Register                      */
    __IO uint32_t Vref3;         /* Offset: 0x64  Inverse Clarke Transformation Output Register                      */
    __IO uint32_t SVPDATA0;      /* Offset: 0x68  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Taon time) */
    __IO uint32_t SVPDATA2;      /* Offset: 0x6C  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Tbon time) */
    __IO uint32_t SVPDATA4;      /* Offset: 0x70  SVPWM output Data Register (it is an unsigned 16-bit value and denotes Tcon time) */
    __IO uint32_t SVPDATA0N;     /* Offset: 0x74  An unsigned16-bit data Normalizes SVPDATA0 to PWMNORM and within the limit between PWMMAX and PWMMIN */
    __IO uint32_t SVPDATA2N;     /* Offset: 0x78  An unsigned 16-bit data Normalizes SVPDATA2 to PWMNORM and within the limit between PWMMAX and PWMMIN */
    __IO uint32_t SVPDATA4N;     /* Offset: 0x7C  An unsigned 16-bit data Normalizes SVPDATA4 to PWMNORM and within the limit between PWMMAX and PWMMIN */
    __O  uint32_t MDUCON;        /* Offset: 0x80  Motor Driver Unit Control Register                                 */
    __IO uint32_t MDUSTS;        /* Offset: 0x84  Motor Driver Unit Status Register                                  */
    __I  uint32_t RESERVE0[30];
    __IO uint32_t PI_dMAX;       /* Offset: 0x100  Maximum limit value of PI_d Controller in Q-15 Format             */
    __IO uint32_t PI_dMIN;       /* Offset: 0x104  Minimum limit value of PI_d Controller in Q-15 Format             */
    __IO uint32_t PI_qMAX;       /* Offset: 0x108  Maximum limit value of PI_q Controller in Q-15 Format             */
    __IO uint32_t PI_qMIN;       /* Offset: 0x10C  Minimum limit value of PI_q Controller in Q-15 Format             */
    __IO uint32_t I_dMAX;        /* Offset: 0x110  Maximum limit value of integral_d Controller in Q-15 Format       */
    __IO uint32_t I_dMIN;        /* Offset: 0x114  Minimum limit value of integral_d Controller in Q-15 Format       */
    __IO uint32_t I_qMAX;        /* Offset: 0x118  Maximum limit value of integral_q Controller in Q-15 Format       */
    __IO uint32_t I_qMIN;        /* Offset: 0x11C  Minimum limit value of integral_q Controller in Q-15 Format       */
    __I  uint32_t Vd_In;         /* Offset: 0x120  Inverse Park Transformation Input of d_axis represented in Q-15 Format */
    __I  uint32_t Vq_In;         /* Offset: 0x124  Inverse Park Transformation Input of q_axis represented in Q-15 Format */
    __IO uint32_t PWMNORM;       /* Offset: 0x128  An Unsigned 16-bit PWM Normalization Value                        */
    __IO uint32_t PWMMAX;        /* Offset: 0x12C  An unsigned 16-bit Maximum Limit Value of SVPWM Output            */
    __IO uint32_t PWMMIN;        /* Offset: 0x130  An unsigned 16-bit Minimum Limit Value of SVPWM Output            */
    __I  uint32_t Id_Err;        /* Offset: 0x134  Error of Id current = Id_CMD ¡V Id                                 */
    __I  uint32_t Iq_Err;        /* Offset: 0x138  Error of Id current = Iq_CMD ¡V Iq                                 */
...
/**
    @addtogroup MDU_CONST MDU Bit Field Definition
    Constant Definitions for MDU Controller
@{ */

#define MDU_Ia_DATA_Pos                  (0)                                               /*!< MDU_T::Ia: DATA Position                  */
#define MDU_Ia_DATA_Msk                  (0xfffful << MDU_Ia_DATA_Pos)                     /*!< MDU_T::Ia: DATA Mask                      */

#define MDU_Ib_DATA_Pos                  (0)                                               /*!< MDU_T::Ib: DATA Position                  */
#define MDU_Ib_DATA_Msk                  (0xfffful << MDU_Ib_DATA_Pos)                     /*!< MDU_T::Ib: DATA Mask                      */

#define MDU_Ic_DATA_Pos                  (0)                                               /*!< MDU_T::Ic: DATA Position                  */
#define MDU_Ic_DATA_Msk                  (0xfffful << MDU_Ic_DATA_Pos)                     /*!< MDU_T::Ic: DATA Mask                      */

#define MDU_Ialfa_DATA_Pos               (0)                                               /*!< MDU_T::Ialfa: DATA Position               */
#define MDU_Ialfa_DATA_Msk               (0xfffful << MDU_Ialfa_DATA_Pos)                  /*!< MDU_T::Ialfa: DATA Mask                   */

#define MDU_Ibeta_DATA_Pos               (0)                                               /*!< MDU_T::Ibeta: DATA Position               */
#define MDU_Ibeta_DATA_Msk               (0xfffful << MDU_Ibeta_DATA_Pos)                  /*!< MDU_T::Ibeta: DATA Mask                   */

#define MDU_SIN_DATA_Pos                 (0)                                               /*!< MDU_T::SIN: DATA Position                 */
#define MDU_SIN_DATA_Msk                 (0xfffful << MDU_SIN_DATA_Pos)                    /*!< MDU_T::SIN: DATA Mask                     */

#define MDU_COS_DATA_Pos                 (0)                                               /*!< MDU_T::COS: DATA Position                 */
#define MDU_COS_DATA_Msk                 (0xfffful << MDU_COS_DATA_Pos)                    /*!< MDU_T::COS: DATA Mask                     */

#define MDU_Id_DATA_Pos                  (0)                                               /*!< MDU_T::Id: DATA Position                  */
#define MDU_Id_DATA_Msk                  (0xfffful << MDU_Id_DATA_Pos)                     /*!< MDU_T::Id: DATA Mask                      */

#define MDU_Iq_DATA_Pos                  (0)                                               /*!< MDU_T::Iq: DATA Position                  */
#define MDU_Iq_DATA_Msk                  (0xfffful << MDU_Iq_DATA_Pos)                     /*!< MDU_T::Iq: DATA Mask                      */

#define MDU_Id_CMD_CMD_Pos               (0)                                               /*!< MDU_T::Id_CMD: CMD Position                  */
#define MDU_Id_CMD_CMD_Msk               (0xfffful << MDU_Id_CMD_CMD_Pos)                     /*!< MDU_T::Id_CMD: CMD Mask                      */

#define MDU_Iq_CMD_CMD_Pos               (0)                                               /*!< MDU_T::Iq_CMD: CMD Position                  */
#define MDU_Iq_CMD_CMD_Msk               (0xfffful << MDU_Iq_CMD_CMD_Pos)                     /*!< MDU_T::Iq_CMD: CMD Mask                      */

#define MDU_KP_d_DATA_Pos                (0)                                               /*!< MDU_T::KP_d: DATA Position                   */
#define MDU_KP_d_DATA_Msk                (0x3fffful << MDU_KP_d_DATA_Pos)                     /*!< MDU_T::KP_d: DATA Mask                       */

#define MDU_KI_d_DATA_Pos                (0)                                               /*!< MDU_T::KI_d: DATA Position                   */
#define MDU_KI_d_DATA_Msk                (0x3fffful << MDU_KI_d_DATA_Pos)                     /*!< MDU_T::KI_d: DATA Mask                       */

#define MDU_KP_q_DATA_Pos                (0)                                               /*!< MDU_T::KP_q: DATA Position                   */
#define MDU_KP_q_DATA_Msk                (0x3fffful << MDU_KP_q_DATA_Pos)                  /*!< MDU_T::KP_q: DATA Mask                       */

#define MDU_KI_q_DATA_Pos                (0)                                               /*!< MDU_T::KI_q: DATA Position                   */
#define MDU_KI_q_DATA_Msk                (0x3fffful << MDU_KI_q_DATA_Pos)                  /*!< MDU_T::KI_q: DATA Mask                       */

#define MDU_PI_dFW_DATA_Pos                 (0)                                               /*!< MDU_T::dFW: DATA Position                 */
#define MDU_PI_dFW_DATA_Msk                 (0xfffful << MDU_PI_dFW_DATA_Pos)                    /*!< MDU_T::dFW: DATA Mask                     */

#define MDU_PI_qFW_DATA_Pos                 (0)                                               /*!< MDU_T::qFW: DATA Position                 */
#define MDU_PI_qFW_DATA_Msk                 (0xfffful << MDU_PI_qFW_DATA_Pos)                    /*!< MDU_T::qFW: DATA Mask                     */

#define MDU_UI_d_DATA_Pos                   (0)                                               /*!< MDU_T::d: DATA Position                   */
#define MDU_UI_d_DATA_Msk                   (0x1ffffful << MDU_UI_d_DATA_Pos)                    /*!< MDU_T::d: DATA Mask                       */

#define MDU_UI_q_DATA_Pos                   (0)                                               /*!< MDU_T::q: DATA Position                   */
#define MDU_UI_q_DATA_Msk                   (0x1ffffful << MDU_UI_q_DATA_Pos)                    /*!< MDU_T::q: DATA Mask                       */

#define MDU_Vd_DATA_Pos                  (0)                                               /*!< MDU_T::Vd: DATA Position                  */
#define MDU_Vd_DATA_Msk                  (0xfffful << MDU_Vd_DATA_Pos)                     /*!< MDU_T::Vd: DATA Mask                      */

#define MDU_Vq_DATA_Pos                  (0)                                               /*!< MDU_T::Vq: DATA Position                  */
#define MDU_Vq_DATA_Msk                  (0xfffful << MDU_Vq_DATA_Pos)                     /*!< MDU_T::Vq: DATA Mask                      */

#define MDU_Valfa_DATA_Pos               (0)                                               /*!< MDU_T::Valfa: DATA Position               */
#define MDU_Valfa_DATA_Msk               (0xfffful << MDU_Valfa_DATA_Pos)                  /*!< MDU_T::Valfa: DATA Mask                   */

#define MDU_Vbeta_DATA_Pos               (0)                                               /*!< MDU_T::Vbeta: DATA Position               */
#define MDU_Vbeta_DATA_Msk               (0xfffful << MDU_Vbeta_DATA_Pos)                  /*!< MDU_T::Vbeta: DATA Mask                   */

#define MDU_Vref1_DATA_Pos               (0)                                               /*!< MDU_T::Vref1: DATA Position               */
#define MDU_Vref1_DATA_Msk               (0xfffful << MDU_Vref1_DATA_Pos)                  /*!< MDU_T::Vref1: DATA Mask                   */

#define MDU_Vref2_DATA_Pos               (0)                                               /*!< MDU_T::Vref2: DATA Position               */
#define MDU_Vref2_DATA_Msk               (0xfffful << MDU_Vref2_DATA_Pos)                  /*!< MDU_T::Vref2: DATA Mask                   */

#define MDU_Vref3_DATA_Pos               (0)                                               /*!< MDU_T::Vref3: DATA Position               */
#define MDU_Vref3_DATA_Msk               (0xfffful << MDU_Vref3_DATA_Pos)                  /*!< MDU_T::Vref3: DATA Mask                   */

#define MDU_SVPDATA0_DATA_Pos            (0)                                               /*!< MDU_T::SVPDATA0: DATA Position            */
#define MDU_SVPDATA0_DATA_Msk            (0xfffful << MDU_SVPDATA0_DATA_Pos)               /*!< MDU_T::SVPDATA0: DATA Mask                */

#define MDU_SVPDATA2_DATA_Pos            (0)                                               /*!< MDU_T::SVPDATA2: DATA Position            */
#define MDU_SVPDATA2_DATA_Msk            (0xfffful << MDU_SVPDATA2_DATA_Pos)               /*!< MDU_T::SVPDATA2: DATA Mask                */

#define MDU_SVPDATA4_DATA_Pos            (0)                                               /*!< MDU_T::SVPDATA4: DATA Position            */
#define MDU_SVPDATA4_DATA_Msk            (0xfffful << MDU_SVPDATA4_DATA_Pos)               /*!< MDU_T::SVPDATA4: DATA Mask                */

#define MDU_SVPDATA0N_DATA_Pos           (0)                                               /*!< MDU_T::SVPDATA0N: DATA Position           */
#define MDU_SVPDATA0N_DATA_Msk           (0xfffful << MDU_SVPDATA0N_DATA_Pos)              /*!< MDU_T::SVPDATA0N: DATA Mask               */

#define MDU_SVPDATA2N_DATA_Pos           (0)                                               /*!< MDU_T::SVPDATA2N: DATA Position           */
#define MDU_SVPDATA2N_DATA_Msk           (0xfffful << MDU_SVPDATA2N_DATA_Pos)              /*!< MDU_T::SVPDATA2N: DATA Mask               */

#define MDU_SVPDATA4N_DATA_Pos           (0)                                               /*!< MDU_T::SVPDATA4N: DATA Position           */
#define MDU_SVPDATA4N_DATA_Msk           (0xfffful << MDU_SVPDATA4N_DATA_Pos)              /*!< MDU_T::SVPDATA4N: DATA Mask               */

#define MDU_MDUCON_CKSTR_Pos             (0)                                               /*!< MDU_T::MDUCON: CKSTR Position             */
#define MDU_MDUCON_CKSTR_Msk             (0x1ul << MDU_MDUCON_CKSTR_Pos)                   /*!< MDU_T::MDUCON: CKSTR Mask                 */

#define MDU_MDUCON_PKSTR_Pos             (1)                                               /*!< MDU_T::MDUCON: PKSTR Position             */
#define MDU_MDUCON_PKSTR_Msk             (0x1ul << MDU_MDUCON_PKSTR_Pos)                   /*!< MDU_T::MDUCON: PKSTR Mask                 */

#define MDU_MDUCON_PIDSTR_Pos            (2)                                               /*!< MDU_T::MDUCON: PIDSTR Position            */
#define MDU_MDUCON_PIDSTR_Msk            (0x1ul << MDU_MDUCON_PIDSTR_Pos)                  /*!< MDU_T::MDUCON: PIDSTR Mask                */

#define MDU_MDUCON_PIQSTR_Pos            (3)                                               /*!< MDU_T::MDUCON: PIQSTR Position            */
#define MDU_MDUCON_PIQSTR_Msk            (0x1ul << MDU_MDUCON_PIQSTR_Pos)                  /*!< MDU_T::MDUCON: PIQSTR Mask                */

#define MDU_MDUCON_INVPKSTR_Pos          (4)                                               /*!< MDU_T::MDUCON: INVPKSTR Position          */
#define MDU_MDUCON_INVPKSTR_Msk          (0x1ul << MDU_MDUCON_INVPKSTR_Pos)                /*!< MDU_T::MDUCON: INVPKSTR Mask              */

#define MDU_MDUCON_INVCKSTR_Pos          (5)                                               /*!< MDU_T::MDUCON: INVCKSTR Position          */
#define MDU_MDUCON_INVCKSTR_Msk          (0x1ul << MDU_MDUCON_INVCKSTR_Pos)                /*!< MDU_T::MDUCON: INVCKSTR Mask              */

#define MDU_MDUCON_SVPWMSTR_Pos          (6)                                               /*!< MDU_T::MDUCON: SVPWMSTR Position          */
#define MDU_MDUCON_SVPWMSTR_Msk          (0x1ul << MDU_MDUCON_SVPWMSTR_Pos)                /*!< MDU_T::MDUCON: SVPWMSTR Mask              */

#define MDU_MDUCON_PKAUTO_Pos            (9)                                               /*!< MDU_T::MDUCON: PKAUTO Position            */
#define MDU_MDUCON_PKAUTO_Msk            (0x1ul << MDU_MDUCON_PKAUTO_Pos)                  /*!< MDU_T::MDUCON: PKAUTO Mask                */

#define MDU_MDUCON_PIDAUTO_Pos           (10)                                              /*!< MDU_T::MDUCON: PIDAUTO Position           */
#define MDU_MDUCON_PIDAUTO_Msk           (0x1ul << MDU_MDUCON_PIDAUTO_Pos)                 /*!< MDU_T::MDUCON: PIDAUTO Mask               */

#define MDU_MDUCON_PIQAUTO_Pos           (11)                                              /*!< MDU_T::MDUCON: PIQAUTO Position           */
#define MDU_MDUCON_PIQAUTO_Msk           (0x1ul << MDU_MDUCON_PIQAUTO_Pos)                 /*!< MDU_T::MDUCON: PIQAUTO Mask               */

#define MDU_MDUCON_INVPKAUTO_Pos         (12)                                              /*!< MDU_T::MDUCON: INVPKAUTO Position         */
#define MDU_MDUCON_INVPKAUTO_Msk         (0x1ul << MDU_MDUCON_INVPKAUTO_Pos)               /*!< MDU_T::MDUCON: INVPKAUTO Mask             */

#define MDU_MDUCON_INVCKAUTO_Pos         (13)                                              /*!< MDU_T::MDUCON: INVCKAUTO Position         */
#define MDU_MDUCON_INVCKAUTO_Msk         (0x1ul << MDU_MDUCON_INVCKAUTO_Pos)               /*!< MDU_T::MDUCON: INVCKAUTO Mask             */

#define MDU_MDUCON_SVPWMAUTO_Pos         (14)                                              /*!< MDU_T::MDUCON: SVPWMAUTO Position         */
#define MDU_MDUCON_SVPWMAUTO_Msk         (0x1ul << MDU_MDUCON_SVPWMAUTO_Pos)               /*!< MDU_T::MDUCON: SVPWMAUTO Mask             */

#define MDU_MDUCON_ATCLRFG_Pos           (16)                                              /*!< MDU_T::MDUCON: ATCLRFG Position           */
#define MDU_MDUCON_ATCLRFG_Msk           (0x1ul << MDU_MDUCON_ATCLRFG_Pos)                 /*!< MDU_T::MDUCON: ATCLRFG Mask               */

#define MDU_MDUCON_SVPWM_DIS_Pos         (17)                                              /*!< MDU_T::MDUCON: SVPWM_DIS Position         */
#define MDU_MDUCON_SVPWM_DIS_Msk         (0x1ul << MDU_MDUCON_SVPWM_DIS_Pos)               /*!< MDU_T::MDUCON: SVPWM_DIS Mask             */

#define MDU_MDUCON_SVPWM_COM_Pos         (18)                                              /*!< MDU_T::MDUCON: SVPWM_COM Position         */
#define MDU_MDUCON_SVPWM_COM_Msk         (0x1ul << MDU_MDUCON_SVPWM_COM_Pos)               /*!< MDU_T::MDUCON: SVPWM_COM Mask             */

#define MDU_MDUCON_SVPWM_X2_Pos          (19)                                              /*!< MDU_T::MDUCON: SVPWM_X2 Position          */
#define MDU_MDUCON_SVPWM_X2_Msk          (0x1ul << MDU_MDUCON_SVPWM_X2_Pos)                /*!< MDU_T::MDUCON: SVPWM_X2 Mask              */

#define MDU_MDUCON_PI_Q20_EN_Pos         (20)                                              /*!< MDU_T::MDUCON: PI_Q20_EN Position         */
#define MDU_MDUCON_PI_Q20_EN_Msk         (0x1ul << MDU_MDUCON_PI_Q20_EN_Pos)               /*!< MDU_T::MDUCON: PI_Q20_EN Mask             */

#define MDU_MDUCON_CK_IE_Pos             (24)                                              /*!< MDU_T::MDUCON: CK_IE Position             */
#define MDU_MDUCON_CK_IE_Msk             (0x1ul << MDU_MDUCON_CK_IE_Pos)                   /*!< MDU_T::MDUCON: CK_IE Mask                 */

#define MDU_MDUCON_PK_IE_Pos             (25)                                              /*!< MDU_T::MDUCON: PK_IE Position             */
#define MDU_MDUCON_PK_IE_Msk             (0x1ul << MDU_MDUCON_PK_IE_Pos)                   /*!< MDU_T::MDUCON: PK_IE Mask                 */

#define MDU_MDUCON_PID_IE_Pos            (26)                                              /*!< MDU_T::MDUCON: PID_IE Position            */
#define MDU_MDUCON_PID_IE_Msk            (0x1ul << MDU_MDUCON_PID_IE_Pos)                  /*!< MDU_T::MDUCON: PID_IE Mask                */

#define MDU_MDUCON_PIQ_IE_Pos            (27)                                              /*!< MDU_T::MDUCON: PIQ_IE Position            */
#define MDU_MDUCON_PIQ_IE_Msk            (0x1ul << MDU_MDUCON_PIQ_IE_Pos)                  /*!< MDU_T::MDUCON: PIQ_IE Mask                */

#define MDU_MDUCON_INVPK_IE_Pos          (28)                                              /*!< MDU_T::MDUCON: INVPK_IE Position          */
#define MDU_MDUCON_INVPK_IE_Msk          (0x1ul << MDU_MDUCON_INVPK_IE_Pos)                /*!< MDU_T::MDUCON: INVPK_IE Mask              */

#define MDU_MDUCON_INVCK_IE_Pos          (29)                                              /*!< MDU_T::MDUCON: INVCK_IE Position          */
#define MDU_MDUCON_INVCK_IE_Msk          (0x1ul << MDU_MDUCON_INVCK_IE_Pos)                /*!< MDU_T::MDUCON: INVCK_IE Mask              */

#define MDU_MDUCON_SVPWM_IE_Pos          (30)                                              /*!< MDU_T::MDUCON: SVPWM_IE Position          */
#define MDU_MDUCON_SVPWM_IE_Msk          (0x1ul << MDU_MDUCON_SVPWM_IE_Pos)                /*!< MDU_T::MDUCON: SVPWM_IE Mask              */

#define MDU_MDUCON_MDU_IE_Pos            (31)                                              /*!< MDU_T::MDUCON: MDU_IE Position            */
#define MDU_MDUCON_MDU_IE_Msk            (0x1ul << MDU_MDUCON_MDU_IE_Pos)                  /*!< MDU_T::MDUCON: MDU_IE Mask                */

#define MDU_MDUSTS_CKCPF_Pos             (0)                                               /*!< MDU_T::MDUSTS: CKCPF Position             */
#define MDU_MDUSTS_CKCPF_Msk             (0x1ul << MDU_MDUSTS_CKCPF_Pos)                   /*!< MDU_T::MDUSTS: CKCPF Mask                 */

#define MDU_MDUSTS_PKCPF_Pos             (1)                                               /*!< MDU_T::MDUSTS: PKCPF Position             */
#define MDU_MDUSTS_PKCPF_Msk             (0x1ul << MDU_MDUSTS_PKCPF_Pos)                   /*!< MDU_T::MDUSTS: PKCPF Mask                 */

#define MDU_MDUSTS_PI_qCPF_Pos           (2)                                               /*!< MDU_T::MDUSTS: PI_qCPF Position           */
#define MDU_MDUSTS_PI_qCPF_Msk           (0x1ul << MDU_MDUSTS_PI_qCPF_Pos)                 /*!< MDU_T::MDUSTS: PI_qCPF Mask               */

#define MDU_MDUSTS_PI_dCPF_Pos           (3)                                               /*!< MDU_T::MDUSTS: PI_dCPF Position           */
#define MDU_MDUSTS_PI_dCPF_Msk           (0x1ul << MDU_MDUSTS_PI_dCPF_Pos)                 /*!< MDU_T::MDUSTS: PI_dCPF Mask               */

#define MDU_MDUSTS_INVPKCPF_Pos          (4)                                               /*!< MDU_T::MDUSTS: INVPKCPF Position          */
#define MDU_MDUSTS_INVPKCPF_Msk          (0x1ul << MDU_MDUSTS_INVPKCPF_Pos)                /*!< MDU_T::MDUSTS: INVPKCPF Mask              */

#define MDU_MDUSTS_INVCKCPF_Pos          (5)                                               /*!< MDU_T::MDUSTS: INVCKCPF Position          */
#define MDU_MDUSTS_INVCKCPF_Msk          (0x1ul << MDU_MDUSTS_INVCKCPF_Pos)                /*!< MDU_T::MDUSTS: INVCKCPF Mask              */

#define MDU_MDUSTS_SVPWMCPF_Pos          (6)                                               /*!< MDU_T::MDUSTS: SVPWMCPF Position          */
#define MDU_MDUSTS_SVPWMCPF_Msk          (0x1ul << MDU_MDUSTS_SVPWMCPF_Pos)                /*!< MDU_T::MDUSTS: SVPWMCPF Mask              */

#define MDU_MDUSTS_ZONE_Pos              (8)                                               /*!< MDU_T::MDUSTS: ZONE Position              */
#define MDU_MDUSTS_ZONE_Msk              (0x7ul << MDU_MDUSTS_ZONE_Pos)                    /*!< MDU_T::MDUSTS: ZONE Mask                  */

#define MDU_PI_dMAX_MAX_Pos                 (0)                                               /*!< MDU_T::dMAX: MAX Position                 */
#define MDU_PI_dMAX_MAX_Msk                 (0xfffful << MDU_PI_dMAX_MAX_Pos)                    /*!< MDU_T::dMAX: MAX Mask                     */

#define MDU_PI_dMIN_MIN_Pos                 (0)                                               /*!< MDU_T::dMIN: MIN Position                 */
#define MDU_PI_dMIN_MIN_Msk                 (0xfffful << MDU_PI_dMIN_MIN_Pos)                    /*!< MDU_T::dMIN: MIN Mask                     */

#define MDU_PI_qMAX_MAX_Pos                 (0)                                               /*!< MDU_T::qMAX: MAX Position                 */
#define MDU_PI_qMAX_MAX_Msk                 (0xfffful << MDU_PI_qMAX_MAX_Pos)                    /*!< MDU_T::qMAX: MAX Mask                     */

#define MDU_PI_qMIN_MIN_Pos                 (0)                                               /*!< MDU_T::qMIN: MIN Position                 */
#define MDU_PI_qMIN_MIN_Msk                 (0xfffful << MDU_PI_qMIN_MIN_Pos)                    /*!< MDU_T::qMIN: MIN Mask                     */

#define MDU_I_dMAX_MAX_Pos                 (0)                                               /*!< MDU_T::dMAX: MAX Position                 */
#define MDU_I_dMAX_MAX_Msk                 (0x1ffffful << MDU_I_dMAX_MAX_Pos)                  /*!< MDU_T::dMAX: MAX Mask                     */

#define MDU_I_dMIN_MIN_Pos                 (0)                                               /*!< MDU_T::dMIN: MIN Position                 */
#define MDU_I_dMIN_MIN_Msk                 (0x1ffffful << MDU_I_dMIN_MIN_Pos)                  /*!< MDU_T::dMIN: MIN Mask                     */

#define MDU_I_qMAX_MAX_Pos                 (0)                                               /*!< MDU_T::qMAX: MAX Position                 */
#define MDU_I_qMAX_MAX_Msk                 (0x1ffffful << MDU_I_qMAX_MAX_Pos)                  /*!< MDU_T::qMAX: MAX Mask                     */

#define MDU_I_qMIN_MIN_Pos                 (0)                                               /*!< MDU_T::qMIN: MIN Position                 */
#define MDU_I_qMIN_MIN_Msk                 (0x1ffffful << MDU_I_qMIN_MIN_Pos)                  /*!< MDU_T::qMIN: MIN Mask                     */

#define MDU_Vd_In_DATA_Pos                  (0)                                               /*!< MDU_T::In: DATA Position                  */
#define MDU_Vd_In_DATA_Msk                  (0xfffful << MDU_Vd_In_DATA_Pos)                     /*!< MDU_T::In: DATA Mask                      */

#define MDU_Vq_In_DATA_Pos                  (0)                                               /*!< MDU_T::In: DATA Position                  */
#define MDU_Vq_In_DATA_Msk                  (0xfffful << MDU_Vq_In_DATA_Pos)                     /*!< MDU_T::In: DATA Mask                      */

#define MDU_PWMNORM_PWMNORM_Pos          (0)                                               /*!< MDU_T::PWMNORM: PWMNORM Position          */
#define MDU_PWMNORM_PWMNORM_Msk          (0xfffful << MDU_PWMNORM_PWMNORM_Pos)             /*!< MDU_T::PWMNORM: PWMNORM Mask              */

#define MDU_PWMMAX_PWMMAX_Pos            (0)                                               /*!< MDU_T::PWMMAX: PWMMAX Position            */
#define MDU_PWMMAX_PWMMAX_Msk            (0xfffful << MDU_PWMMAX_PWMMAX_Pos)               /*!< MDU_T::PWMMAX: PWMMAX Mask                */

#define MDU_PWMMIN_PWMMIN_Pos            (0)                                               /*!< MDU_T::PWMMIN: PWMMIN Position            */
#define MDU_PWMMIN_PWMMIN_Msk            (0xfffful << MDU_PWMMIN_PWMMIN_Pos)               /*!< MDU_T::PWMMIN: PWMMIN Mask                */

/**@}*/ /* MDU_CONST */
/**@}*/ /* end of MDU register group */
...
typedef struct
{
    ...
    /**
     * @var QEI_T::CNT
     * Offset: 0x00  QEI Pulse Counter Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |VAL       |Quadrature Encoder Pulse Counter
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |VAL       |Quadrature Encoder Pulse Counter Hold Register
     * |        |          |When bit HOLDCNT (QEI_CTL[24]) goes from low to high, the QEI_CNT value is copied into QEI_CNTHOLD register.
     * @var QEI_T::CNTLATCH
     * Offset: 0x08  QEI Pulse Counter Index Latch Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |VAL       |Quadrature Encoder Pulse Counter Index Latch
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |VAL       |Quadrature Encoder Pulse Counter Compare
     * |        |          |If the QEI controller is in the compare-counting mode CMPEN (QEI_CTL[28]) = 1, when the value of QEI_CNT matches the value of VAL the bit CMPF (QEI_STATUS[1]) will be set.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |VAL       |Quadrature Encoder Preset Maximum Count
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[1:0]   |NFCLKSEL  |Noise Filter Clock Pre-Divide Selection
     * |        |          |To determine the sampling frequency of the Noise Filter clock.
     * |        |          |00 = QEI_CLK.
     * |        |          |01 = QEI_CLK/2.
     * |        |          |10 = QEI_CLK/4.
     ...
     * |        |          |This bit may be set by writing 1 to it or Timer0~Timer3 interrupt flag TIF (TISRx[0], x=0~3).
     * |        |          |0 = No operation.
     ...
     * |        |          |When this bit is high and a rising edge comes on signal CHX, the QEI_CNT will be reset to zero if the counter is in up-counting type (DIRF (QEI_STATUS[8]) = 1);
     * |        |          |while the QEI_CNT will be reloaded with QEI_CNTMAX content if the counter is in down-counting type (DIRF = 0).
     * |        |          |0 = Reload function Disabled.
     * |        |          |1 = QEI_CNT re-initialized by Index signal Enabled.
     * |[28]    |CMPEN     |The Compare Function Enable Bit
     * |        |          |The compare function in QEI controller is to compare the dynamic counting QEI_CNT with the compare register QEI_CNTCMP, if QEI_CNT value reaches QEI_CNTCMP, the flag CMPF (QEI_STATUS[1]) will be set.
     ...
     * |        |          |Flag is set by hardware while QEI_CNT overflows from 0xFFFF_FFFF to zero in free-counting mode or from the QEI_CNTMAX value to zero in compare-counting mode.
     * |        |          |Similarly, the flag is set while QEI counter underflow from zero to 0xFFFF_FFFF or QEI_CNTMAX.
    ...
    __IO uint32_t CNT;           /* Offset: 0x00  QEI Pulse Counter Register                                         */
    __IO uint32_t CNTHOLD;       /* Offset: 0x04  QEI Pulse Counter Hold Register                                    */
    __IO uint32_t CNTLATCH;      /* Offset: 0x08  QEI Pulse Counter Index Latch Register                             */
    __IO uint32_t CNTCMP;        /* Offset: 0x0C  QEI Pulse Counter Compare Register                                 */
    __I  uint32_t RESERVE0[1];
    __IO uint32_t CNTMAX;        /* Offset: 0x14  QEI Pre-set Maximum Count Register                                 */
    __IO uint32_t CTL;           /* Offset: 0x18  QEI Controller Control Register                                    */
    __I  uint32_t RESERVE1[4];
    __IO uint32_t STATUS;        /* Offset: 0x2C  QEI Controller Status Register                                     */
...
#define QEI_CTL_NFCLKSEL_Msk             (0x3ul << QEI_CTL_NFCLKSEL_Pos)                   /*!< QEI_T::CTL: NFCLKSEL Mask                 */
...
typedef struct
{
     ...
     * |[18]    |MDU_RST   |MDU Controller Reset
     * |        |          |0 = MDU controller normal operation.
     * |        |          |1 = MDU controller reset.
     ...
     * |[24]    |CAN_RST   |CAN Controller Reset 
     * |        |          |0 = CAN controller normal operation. 
     * |        |          |1 = CAN controller reset.      
     ...
     * |[30]    |QEI0_RST  |QEI0 Controller Reset
     * |        |          |0 = QEI0 controller normal operation.
     * |        |          |1 = QEI0 controller reset.
     * |[31]    |QEI1_RST  |QEI1 Controller Reset
     ...
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = QEI0_A function is selected. 
     * |        |          |(1, 1) = CAN_RXD function selected.     
     ...
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = QEI0_B function is selected. 
     * |        |          |(1, 1) = CAN_TXD function selected.     
     ...
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = QEI0_Z function is selected.
     ...
     * |        |          |See P2_MFP[0].
     * |[12]    |P2_ALT[4] |P2.4 Alternative Function
     * |        |          |See P2_MFP[4].
     * |[13]    |P2_ALT[5] |P2.5 Alternative Function
     * |        |          |See P2_MFP[5].     
     ...
     * |        |          |This bit selects P3.3 multi-function.
     * |        |          |0 = GPIO function is selected.
     ...
     * |[6]     |P3_MFP[6] |P3.6 Multi-Function Selection
     * |        |          |This bit selects P3.6 multi-function.
     * |        |          |0 = GPIO function is selected.
     * |        |          |1 = CAN_RXD function is selected.    
     * |[7]     |P3_MFP[7] |P3.7 Multi-Function Selection
     * |        |          |This bit selects P3.7 multi-function.
     * |        |          |0 = GPIO function is selected.
     * |        |          |1 = CAN_TXD function is selected.       
     ...
     * |        |          |(1, 0) = QEI1_Z function is selected.
     ...
     * |[23:16] |P7_TYPEn  |P7[7:0] Input Schmitt Trigger Function Enable
     ...
     * |[23:16] |P8_TYPEn  |P8[7:0] Input Schmitt Trigger Function Enable
     ...
     * |[23:16] |P9_TYPEn  |P9[7:0] Input Schmitt Trigger Function Enable
     ...
     * |        |          |See PA_MFP[1].
     * |[23:16] |PA_TYPEn  |PA[7:0] Input Schmitt Trigger Function Enable
...
#define SYS_IPRSTC2_QEI1_RST_Pos                31                                  /*!< GCR_T::IPRSTC2: QEI1_RST Position */
#define SYS_IPRSTC2_QEI1_RST_Msk                (1ul << SYS_IPRSTC2_QEI1_RST_Pos)   /*!< GCR_T::IPRSTC2: QEI1_RST Mask */

#define SYS_IPRSTC2_QEI0_RST_Pos                30                                  /*!< GCR_T::IPRSTC2: QEI0_RST Position */
#define SYS_IPRSTC2_QEI0_RST_Msk                (1ul << SYS_IPRSTC2_QEI0_RST_Pos)   /*!< GCR_T::IPRSTC2: QEI0_RST Mask */
...
#define SYS_IPRSTC2_CAN_RST_Pos                 24                                  /*!< GCR_T::IPRSTC2: CAN_RST Position */
#define SYS_IPRSTC2_CAN_RST_Msk                 (1ul << SYS_IPRSTC2_CAN_RST_Pos)    /*!< GCR_T::IPRSTC2: CAN_RST Mask */
...
#define SYS_IPRSTC2_MDU_RST_Pos                 18                                  /*!< GCR_T::IPRSTC2: MDU_RST Position */
#define SYS_IPRSTC2_MDU_RST_Msk                 (1ul << SYS_IPRSTC2_MDU_RST_Pos)    /*!< GCR_T::IPRSTC2: MDU_RST Mask */
...
typedef struct
{
    ...
    * |[4]     |TOUT_IEN  |RX Time-out Interrupt Enable
    ...
    * |        |          |(for Non-Automatic Resynchronization mode, this bit should be kept cleared). (Slave mode with automatic resynchronization).
...
#define QEI0_BASE            (APB2_BASE      + 0xC0000)                 /*!< QEI0 Base Address                                */
#define QEI1_BASE            (APB2_BASE      + 0xC4000)                 /*!< QEI1 Base Address                                */

#define MDU0_BASE            (APB2_BASE      + 0xD0000)                 /*!< MDU0 Base Address                                */
#define MDU1_BASE            (APB2_BASE      + 0xD4000)                 /*!< MDU1 Base Address                                */
#define MDUG_BASE            (APB2_BASE      + 0xD0800)                 /*!< MDUG Base Address                                */

#define CAN_BASE             (APB2_BASE      + 0x80000)                 /*!< CAN Base Address                                 */
...
#define QEI0                ((QEI_T *) QEI0_BASE)                       /*!< QEI0 Configuration Struct                        */
#define QEI1                ((QEI_T *) QEI1_BASE)                       /*!< QEI1 Configuration Struct                        */

#define MDU0                ((MDU_T *) MDU0_BASE)                       /*!< MDU0 Configuration Struct                        */
#define MDU1                ((MDU_T *) MDU1_BASE)                       /*!< MDU1 Configuration Struct                        */
#define MDUG                ((MDUG_T *) MDUG_BASE)                      /*!< MDUG Configuration Struct                        */
#define CAN                 ((CAN_T *) CAN_BASE)                        /*!< CAN Configuration Struct                         */
