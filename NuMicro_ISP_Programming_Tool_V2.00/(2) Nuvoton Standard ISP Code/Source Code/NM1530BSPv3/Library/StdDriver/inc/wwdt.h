 ...
 * $Revision: 2 $
 * $Date: 15/04/01 3:00p $
 * @brief    NM1530 series WWDT driver header file
 *
 * @note
...
/** @addtogroup NM1530_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup NM1530_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NM1530_WWDT_EXPORTED_CONSTANTS */


/** @addtogroup NM1530_WWDT_EXPORTED_FUNCTIONS WWDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group NM1530_WWDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1530_WWDT_Driver */
