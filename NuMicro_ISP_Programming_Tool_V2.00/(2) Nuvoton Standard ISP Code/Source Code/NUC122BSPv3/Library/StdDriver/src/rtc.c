...
/**
  ...
  *                         - u32Day: Day value.
  *                         - u32DayOfWeek:The Day of the week. It could be:
  *                             - \ref RTC_SUNDAY
  *                             - \ref RTC_MONDAY
  *                             - \ref RTC_TUESDAY
  *                             - \ref RTC_WEDNESDAY 
...
/**
  ...
  * @param[in]  u32DayOfWeek    The Day of the week. It could be:
  *                                 - \ref RTC_SUNDAY 
  *                                 - \ref RTC_MONDAY 
  *                                 - \ref RTC_TUESDAY
  *                                 - \ref RTC_WEDNESDAY 
...
/**
  ...
  * @param[in]  u32TimeMode     The 24-Hour / 12-Hour Time Scale Selection. It could be:
  *                                 - \ref RTC_CLOCK_12 
  *                                 - \ref RTC_CLOCK_24
...
/**
  ...
  *                                 - \ref RTC_CLOCK_12 
  *                                 - \ref RTC_CLOCK_24
  * @param[in]  u32AmPm         12-hour time scale with AM and PM indication. Only Time Scale select 12-hour used. It could be:
  *                                 - \ref RTC_AM 
  *                                 - \ref RTC_PM
  *
  * @return     None
