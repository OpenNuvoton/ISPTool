...
void USBD_GetDescriptor(void)
{
    ...
    switch(g_usbd_SetupPacket[3])
    {
        ...
        case DESC_DEVICE:
        {
            ...
            pu8Buf = (uint8_t *)g_usbd_sInfo->gu8DevDesc;
            break;
        }
        ...
        case DESC_CONFIG:
        {
            ...
            pu8Buf = (uint8_t *)g_usbd_sInfo->gu8ConfigDesc;
        ...
        case DESC_HID:
        {
            ...
            pu8Buf = (uint8_t *)&g_usbd_sInfo->gu8ConfigDesc[u32ConfigDescOffset];
        ...
        case DESC_HID_RPT:
        {
            ...
            pu8Buf = (uint8_t *)g_usbd_sInfo->gu8HidReportDesc[g_usbd_SetupPacket[4]];
            break;
        }
        ...
        case DESC_STRING:
        {
            ...
            if(g_usbd_SetupPacket[2] < 4)
            {
                ...
                pu8Buf = (uint8_t *)g_usbd_sInfo->gu8StringDesc[g_usbd_SetupPacket[2]];
    ...
    {
        USBD_SET_DATA1(EP0);
        USBD_PrepareCtrlIn(pu8Buf, u32Len);
        }
    else
    {
            USBD_SET_EP_STALL(EP0);
...
void USBD_StandardRequest(void)
{
    ...
    if(g_usbd_SetupPacket[0] & 0x80)    /* request data transfer direction */
    {
        ...
        switch(g_usbd_SetupPacket[1])
        {
            ...
            {
                USBD_GetDescriptor();
                USBD_SET_PAYLOAD_LEN(EP1, g_usbd_CtrlMaxPktSize); /* For status stage */
                break;
            }
            case GET_INTERFACE:
            {
