 ...
 * $Revision: 1 $
 * $Date: 15/04/07 2:47p $ 
 * @brief    NM1200_NM1100 GPIO driver header file
 *
 * @note
...
/** @addtogroup NM1200_NM1100_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup NM1200_NM1100_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1200_NM1100_GPIO_EXPORTED_CONSTANTS */

/** @addtogroup NM1200_NM1100_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
 ...
 */
#define GPIO_SET_DEBOUNCE_TIME(clksrc, clksel)  (GPIO->DBNCECON = (GP_DBNCECON_ICLKON_Msk | clksrc | clksel))
...
/*@}*/ /* end of group NM1200_NM1100_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1200_NM1100_GPIO_Driver */
