 ...
 * @param[in]   u32SrcCtrl      Source control attribute. \ref PDMA_SAR_INC or \ref PDMA_SAR_FIX or \ref PDMA_SAR_WRA
 * @param[in]   u32DstAddr      destination address
 * @param[in]   u32DstCtrl      destination control attribute. \ref PDMA_DAR_INC or \ref PDMA_DAR_FIX or \ref PDMA_DAR_WRA
 *
 * @return      None
 *
 ...
 *
 * @param[in]   u32Ch           The selected channel
 * @param[in]   u32Peripheral   The selected peripheral. \ref PDMA_SPI0_TX, \ref PDMA_UART0_TX, \ref PDMA_I2S_TX,... \ref PDMA_MEM
