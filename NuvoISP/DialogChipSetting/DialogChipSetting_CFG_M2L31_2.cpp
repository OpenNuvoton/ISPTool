...
BEGIN_MESSAGE_MAP(CDialogChipSetting_CFG_M2L31_2, CDialog)
    ...
    //}}AFX_MSG_MAP
    ON_BN_CLICKED(IDC_GROUP_DATA_FLASH, &CDialogChipSetting_CFG_M2L31_2::OnBnClickedGroupDataFlash)
    ON_EN_CHANGE(IDC_EDIT_DATA_FLASH_SIZE, &CDialogChipSetting_CFG_M2L31_2::OnEnChangeEditDataFlashSize)
END_MESSAGE_MAP()
...
void CDialogChipSetting_CFG_M2L31_2::OnBnClickedGroupDataFlash()
{
    // TODO: Add your control notification handler code here
}


void CDialogChipSetting_CFG_M2L31_2::OnEnChangeEditDataFlashSize()
{
