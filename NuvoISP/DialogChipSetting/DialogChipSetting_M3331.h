...
public:
    CDialogChipSetting_M3331(BOOL bSecureDebug = TRUE, unsigned int uPID = 0, unsigned int uDID = 0x7690, unsigned int uChipSeries = PROJ_M3331G, CWnd* pParent = NULL);    // standard constructor
