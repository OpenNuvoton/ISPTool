#if !defined(AFX_DIALOGCHIPSETTING_M2L31_H__INCLUDED_)
#define AFX_DIALOGCHIPSETTING_M2L31_H__INCLUDED_
...
public:
    CDialogChipSetting_M2L31(unsigned int uProgramMemorySize, unsigned int uFlashPageSize, unsigned int uPID, unsigned int uDID, unsigned int uChipSeries, CWnd *pParent = NULL);	// standard constructor
