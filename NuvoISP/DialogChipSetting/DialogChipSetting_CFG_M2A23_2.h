#if !defined(AFX_DIALOGCHIPSETTING_CFG_M2A23_2_H__INCLUDED_)
#define AFX_DIALOGCHIPSETTING_CFG_M2A23_2_H__INCLUDED_
...
class CDialogChipSetting_CFG_M2A23_2 : public CDialogResize
{
    DECLARE_DYNAMIC(CDialogChipSetting_CFG_M2A23_2)

// Construction
public:
    CDialogChipSetting_CFG_M2A23_2(int edit_8, CWnd *pParent = NULL);		// standard constructor

// Dialog Data
    //{{AFX_DATA(CDialogChipSetting_CFG_M460)
    enum { IDD = IDD_DIALOG_CHIP_SETTING_CFG_M2A23_2 };
    ...
    unsigned int	m_uPID;
    unsigned int	m_uDID;
    unsigned int	m_uConfigValue[2];
    unsigned int	m_uConfigValue_t[2];
    //}}AFX_DATA
