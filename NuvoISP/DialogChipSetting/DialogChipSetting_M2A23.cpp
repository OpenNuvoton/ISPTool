...
CDialogChipSetting_M2A23::CDialogChipSetting_M2A23(unsigned int uProgramMemorySize, unsigned int uFlashPageSize, unsigned int uPID, unsigned int uDID, unsigned int uChipSeries, CWnd *pParent /*=NULL*/)
...
BOOL CDialogChipSetting_M2A23::OnInitDialog()
{
    ...
    if (m_uShowFlag & 0x01) {
        m_TabChipSetting.InsertItem(nItem++, _T("Configuration 0-2"));
    ...
    if (m_uShowFlag & 0x02) {
        ...
        if ((m_uConfigValue[10] & 0xFFFF) == 0xFFFF) {
            m_pChipSetting_CFG_2 = new CDialogChipSetting_CFG_M2A23_2(TRUE);
        }
        else {
            m_pChipSetting_CFG_2 = new CDialogChipSetting_CFG_M2A23_2(FALSE);
        }
        ...
        m_pChipSetting_CFG_2->m_uConfigValue[1] = m_uConfigValue[10];
        m_pChipSetting_CFG_2->Create(CDialogChipSetting_CFG_M2A23_2::IDD, &m_TabChipSetting);
    }
...
void CDialogChipSetting_M2A23::OnOk()
{
    ...
    if (m_uShowFlag & 0x02) {
        ...
        m_uConfigValue[10] = m_pChipSetting_CFG_2->m_uConfigValue[1];
    }
