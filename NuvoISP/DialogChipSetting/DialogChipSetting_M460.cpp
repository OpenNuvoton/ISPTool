...
CDialogChipSetting_M460::CDialogChipSetting_M460(unsigned int uPID, unsigned int uDID, unsigned int uChipSeries, CWnd* pParent /*=NULL*/)
...
BOOL CDialogChipSetting_M460::OnInitDialog()
{
    ...
    if (m_uShowFlag & 0x01)
    {
        m_TabChipSetting.InsertItem(nItem++, _T("CONFIG 0-3"));
