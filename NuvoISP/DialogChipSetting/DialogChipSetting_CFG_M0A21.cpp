    ...
    , m_ALOCK(16, 2)
{
    ...
    m_uProgramMemorySize    = M0A21_MAX_APROM_SIZE;
...
CDialogChipSetting_CFG_M0A21::~CDialogChipSetting_CFG_M0A21()
{
}
    ...
    : CDialogChipSetting_CFG_M0A21(pParent)
{
    ...
    m_uProgramMemorySize    = M030G_MAX_APROM_SIZE;
    m_uFlashPageSize        = NUMICRO_FLASH_PAGE_SIZE_512;
    //}}AFX_DATA_INIT
}
    ...
    : CDialogChipSetting_CFG_M0A21(pParent)
{
    ...
    m_uProgramMemorySize    = M031_MAX_APROM_SIZE;
    m_uFlashPageSize        = NUMICRO_FLASH_PAGE_SIZE_2K;
    //}}AFX_DATA_INIT
}
...
IMPLEMENT_DYNAMIC(CDialogChipSetting_CFG_M2003, CDialog)

CDialogChipSetting_CFG_M2003::CDialogChipSetting_CFG_M2003(CWnd* pParent /*=NULL*/)
    : CDialogChipSetting_CFG_M0A21(pParent)
{
...
void CDialogChipSetting_CFG_M2003::UpdateUI()
{
    GetDlgItem(IDC_RADIO_BS_APROM_LDROM)->ShowWindow(SW_HIDE);
    GetDlgItem(IDC_RADIO_BS_LDROM_APROM)->ShowWindow(SW_HIDE);
    ...
    GetDlgItem(IDC_GROUP_RPD)->SetWindowText(_T("PE.15 Mode Selection"));
    ...
    RECT rcTmp, rcGroupRSTEXT, rcGroupCBS, rcGroupCFGXT1, rcGroupCFGRPS, rcGroupLOCK, rcGroupDFEN;
    LONG lDiff;
...
void CDialogChipSetting_CFG_M2003::ConfigToGUI()
{
    m_uConfigValue_t[0] = m_uConfigValue[0];
    m_uConfigValue_t[1] = m_uConfigValue[1];
    m_uConfigValue_t[2] = m_uConfigValue[2];
...
void CDialogChipSetting_CFG_M2003::GUIToConfig()
{
    UpdateData(TRUE);
    ...
    : CDialogChipSetting_CFG_M0A21(pParent)
{
    ...
    m_uProgramMemorySize    = M451_MAX_APROM_SIZE;
    m_uFlashPageSize        = NUMICRO_FLASH_PAGE_SIZE_2K;
    //}}AFX_DATA_INIT
}
    ...
    : CDialogChipSetting_CFG_M0A21(pParent)
{
    ...
    m_uProgramMemorySize    = M471_MAX_APROM_SIZE;
    m_uFlashPageSize        = NUMICRO_FLASH_PAGE_SIZE_2K;
    //}}AFX_DATA_INIT
}
...
CDialogChipSetting_CFG_M2A23::CDialogChipSetting_CFG_M2A23(CWnd* pParent /*=NULL*/)
    : CDialogChipSetting_CFG_M0A21(pParent)
{
    //{{AFX_DATA_INIT(CDialogChipSetting_CFG_M2A23)
    //}}AFX_DATA_INIT
}
...
void CDialogChipSetting_CFG_M2A23::UpdateUI()
{
    ...
    RECT rcTmp, rcGroupCFGXT1, rcGroupCBOD;
    LONG lDiff;
