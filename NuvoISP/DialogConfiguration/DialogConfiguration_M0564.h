...
class CDialogConfiguration_NUC1263 : public CDialogConfiguration_M0564
{
public:
    CDialogConfiguration_NUC1263(unsigned int uProgramMemorySize = 64 * 1024, CWnd* pParent = NULL);
protected:
    virtual BOOL OnInitDialog();
};
