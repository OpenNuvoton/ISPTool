...
CDialogConfiguration_N572::CDialogConfiguration_N572(CWnd* pParent /*=NULL*/)
    : CDialogResize(CDialogConfiguration_N572::IDD, pParent)
{
...
void CDialogConfiguration_N572::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_CHECK_WDT_ENABLE, m_bWatchDogEnable);
...
BEGIN_MESSAGE_MAP(CDialogConfiguration_N572, CDialog)
    ...
    ON_BN_CLICKED(IDC_RADIO_CLK_E12M6M, OnButtonClick)
    ON_BN_CLICKED(IDC_RADIO_CLK_I24M, OnButtonClick)
    ON_BN_CLICKED(IDC_RADIO_CVDTV_27, OnButtonClick)
    ON_BN_CLICKED(IDC_RADIO_CVDTV_30, OnButtonClick)
    ON_BN_CLICKED(IDC_CHECK_WDT_ENABLE, OnButtonClick)
    ON_BN_CLICKED(IDC_CHECK_CLOCK_FILTER_ENABLE, OnButtonClick)
    ON_BN_CLICKED(IDC_CHECK_CVDEN, OnButtonClick)
...
void CDialogConfiguration_N572::GUIToConfig()
{
    ...
    {
        case 0:
            uConfig0 |= N572_FLASH_CONFIG_E12M6M;
            break;
...
void CDialogConfiguration_N572::OnButtonClick()
{
