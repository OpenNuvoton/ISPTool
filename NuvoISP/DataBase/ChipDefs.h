...
#define NUMICRO_M0_AHB_BASE				0x50000000UL	// NuMicro M0
#define NUMICRO_M4_AHB_BASE				0x40000000UL	// NuMicro M4 and Grebe

#define NUMICRO_GCR_BASE				0x00000
#define NUMICRO_CLK_BASE				0x00200
#define NUMICRO_FMC_BASE				0x0C000

#define NUMICRO_REG_PDID				(NUMICRO_GCR_BASE + 0x000)
#define NUMICRO_REG_RSTSTS				(NUMICRO_GCR_BASE + 0x004)
#define NUMICRO_REG_IPRST0				(NUMICRO_GCR_BASE + 0x008)
#	define NUMICRO_REG_IPRST0_CHIPRST	0x00000001UL
#define NUMICRO_REG_REGLCTL				(NUMICRO_GCR_BASE + 0x100)
#	define NUMICRO_REG_REGLCTL_REGLCTL	0x00000001UL

#define NUMICRO_REG_PWRCTL				(NUMICRO_CLK_BASE + 0x000)
#	define NUMICRO_REG_PWRCTL_HIRCEN	0x00000004UL

#define NUMICRO_REG_ISPCTL				(NUMICRO_FMC_BASE + 0x000)
#	define NUMICRO_REG_ISPCTL_ISPFF		0x00000040UL
#	define NUMICRO_REG_ISPCTL_BS		0x00000002UL
#	define NUMICRO_REG_ISPCTL_ISPEN		0x00000001UL
#define NUMICRO_REG_ISPADDR				(NUMICRO_FMC_BASE + 0x004)
#define NUMICRO_REG_ISPDAT				(NUMICRO_FMC_BASE + 0x008)
#define NUMICRO_REG_ISPCMD				(NUMICRO_FMC_BASE + 0x00C)
#define NUMICRO_REG_ISPTRG				(NUMICRO_FMC_BASE + 0x010)
#	define NUMICRO_REG_ISPTRG_ISPGO		0x00000001UL
#define NUMICRO_REG_ICPCTL				(NUMICRO_FMC_BASE + 0x01C)
#	define NUMICRO_REG_ICPCTL_ICPEN		0x00000001UL
#define NUMICRO_REG_ISPSTS				(NUMICRO_FMC_BASE + 0x040)
#	define NUMICRO_REG_ISPSTS_PGFF		0x00000020UL
#define NUMICRO_REG_KPKEYSTS			(NUMICRO_FMC_BASE + 0x060)
#	define NUMICRO_REG_KPKEYSTS_KEYLOCK	0x00000002UL

#define NUMICRO_ISPCMD_READ				0x00UL
#define NUMICRO_ISPCMD_READCID			0x0BUL
#define NUMICRO_ISPCMD_READDID			0x0CUL
#define NUMICRO_ISPCMD_READUID			0x04UL
#define NUMICRO_ISPCMD_PROGRAM			0x21UL
#define NUMICRO_ISPCMD_PAGEERASE		0x22UL
#define NUMICRO_ISPCMD_CHIPERASE		0x26UL
