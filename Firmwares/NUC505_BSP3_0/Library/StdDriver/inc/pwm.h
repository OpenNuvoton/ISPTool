 ...
 *                           0 represents channel 0, 1 represents channel 1...
 * @return None
 * \hideinitializer
 */
#define PWM_ENABLE_OUTPUT_INVERTER(pwm, u32ChannelNum) (pwm->CTL |= (1 << (8 * u32ChannelNum + 2))
 ...
 * \hideinitializer
 */
#define PWM_SET_CMR(pwm, u32ChannelNum, u32CMR) (*(__IO uint32_t *)(&pwm->CMPDAT0 + 2 * u32ChannelNum) = (u32CMR))
 ...
 * \hideinitializer
 */
#define PWM_SET_CNR(pwm, u32ChannelNum, u32CNR)  (*(__IO uint32_t *)(&pwm->PERIOD0 + 2 * u32ChannelNum) = (u32CNR))
