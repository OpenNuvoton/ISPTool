...
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat, uint32_t u32AudioInterface)
{
    ...
    if((uint32_t)i2s == I2S_BASE) {
		...
		{
			i2s->CTL = u32MasterSlave | u32WordWidth | u32Channels | u32DataFormat | I2S_CTL_CODECRST_Msk | I2S_FIFO_TX_LEVEL_WORD_8 | I2S_FIFO_RX_LEVEL_WORD_9;
			i2s->CTL &= ~I2S_CTL_CODECSEL_Msk;
			u32WordWidth = I2S_DATABIT_32;
		}
		else if ( u32AudioInterface == 0 )
		{
			i2s->CTL = u32MasterSlave | u32WordWidth | u32Channels | u32DataFormat | I2S_CTL_CODECSEL_Msk | I2S_FIFO_TX_LEVEL_WORD_8 | I2S_FIFO_RX_LEVEL_WORD_9;
			i2s->CTL &= ~I2S_CTL_CODECRST_Msk;
		}
		else
		{
			i2s->CTL = u32MasterSlave | u32WordWidth | u32Channels | u32DataFormat | I2S_CTL_CODECRST_Msk | I2S_CTL_CODECSEL_Msk | I2S_FIFO_TX_LEVEL_WORD_8 | I2S_FIFO_RX_LEVEL_WORD_9;
			u32WordWidth = I2S_DATABIT_32;
		}
