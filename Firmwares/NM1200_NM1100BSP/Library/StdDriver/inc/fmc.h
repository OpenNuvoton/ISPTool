 ...
 * $Revision: 2 $
 * $Date: 15/05/25 3:56p $
 * @brief    NM1200_NM1100 FMC driver header file
 *
 * @note
...
/** @addtogroup NM1200_NM1100_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
/* Define Base Address                                                                                     */
...
/*@}*/ /* end of group NM1200_NM1100_FMC_EXPORTED_CONSTANTS */
