 ...
 * $Revision: 1 $
 * $Date: 15/04/07 2:47p $
 * @brief    NM1200_NM1100 Analog Comparator(ACMP) driver header file
 *
 * @note
...
/** @addtogroup NM1200_NM1100_ACMP_Driver ACMP Driver
  @{
*/

/** @addtogroup NM1200_NM1100_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1200_NM1100_ACMP_EXPORTED_CONSTANTS */


/** @addtogroup NM1200_NM1100_ACMP_EXPORTED_FUNCTIONS ACMP Exported Functions
  @{
*/
...
/**
  ...
  * \hideinitializer
  */
#define ACMP_CRV_SEL(acmp, u32Level) (ACMP->VREF = (ACMP->VREF & ~ACMP_VREF_CRVS_Msk) | (u32Level & ~ACMP_VREF_IREFSEL_Msk))
/**
...
/*@}*/ /* end of group NM1200_NM1100_ACMP_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1200_NM1100_ACMP_Driver */
