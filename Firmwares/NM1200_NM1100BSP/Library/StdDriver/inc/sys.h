 ...
 * $Revision: 1 $
 * $Date: 15/04/07 2:47p $ 
 * @brief    NM1200_NM1100 SYS driver header file
 *
 * @note
...
/** @addtogroup NM1200_NM1100_SYS_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/    
/*---------------------------------------------------------------------------------------------------------*/
/*  Module Reset Control Resister constant definitions.                                                    */
/*---------------------------------------------------------------------------------------------------------*/
#define CHIP_RST ((0x0<<24) | SYS_IPRST0_CHIPRST_Pos   ) /*!< CHIP reset is one of the SYS_ResetModule parameter */
#define CPU_RST  ((0x0<<24) | SYS_IPRST0_CPURST_Pos    ) /*!< CPU  reset is one of the SYS_ResetModule parameter */
...
#define SYS_BODCTL_BOD_DISABLE             (3UL<<SYS_BODCTL_BODVL1_0_Pos)       /*!< Disable Brown Out Detector */ 
#define SYS_BODCTL_BOD_VL_4_4V             (3UL<<SYS_BODCTL_BODVL1_0_Pos)       /*!< Setting Brown Out Detector Threshold Voltage as 4.4V */ 
#define SYS_BODCTL_BOD_VL_3_7V             (2UL<<SYS_BODCTL_BODVL1_0_Pos)       /*!< Setting Brown Out Detector Threshold Voltage as 3.7V */
#define SYS_BODCTL_BOD_VL_2_7V             (1UL<<SYS_BODCTL_BODVL1_0_Pos)       /*!< Setting Brown Out Detector Threshold Voltage as 2.7V */
#define SYS_BODCTL_BOD_VL_2_2V             (0UL<<SYS_BODCTL_BODVL1_0_Pos)       /*!< Setting Brown Out Detector Threshold Voltage as 2.2V */
...
/*@}*/ /* end of group NM1200_NM1100_SYS_EXPORTED_CONSTANTS */

/** @addtogroup NM1200_NM1100_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
#define SYS_CLEAR_BOD_INT_FLAG()        (SYS->BODCTL |= SYS_BODCTL_BODIF_Msk)        /*!< This macro clear Brown-out interrupt flag */    
#define SYS_CLEAR_BOD_LPM()             (SYS->BODCTL &= ~SYS_BODCTL_BODLPM_Msk)         /*!< This macro set Brown-out detect to normal mode */
#define SYS_DISABLE_BOD()               (SYS->BODCTL &= ~SYS_BODCTL_BOD_DISABLE)          /*!< This macro disable Brown-out detect function */
#define SYS_ENABLE_BOD()                (SYS->BODCTL = (SYS->BODCTL & ~SYS_BODCTL_BODVL1_0_Msk) | SYS_BODCTL_BOD_VL_3_7V) /*!< This macro enable Brown-out detect function and set BOD_LV=3.7V */
#define SYS_GET_BOD_INT_FLAG()          (SYS->BODCTL & SYS_BODCTL_BODIF_Msk)          /*!< This macro get Brown-out detect interrupt flag */
#define SYS_GET_BOD_OUTPUT()            (SYS->BODCTL & SYS_BODCTL_BODOUT_Msk)           /*!< This macro get Brown-out detector output status */
#define SYS_DISABLE_BOD_RST()           (SYS->BODCTL &= ~SYS_BODCTL_BODRSTEN_Msk)       /*!< This macro enable Brown-out detect interrupt function */
#define SYS_ENABLE_BOD_RST()            (SYS->BODCTL |= SYS_BODCTL_BODRSTEN_Msk)        /*!< This macro enable Brown-out detect reset function */
#define SYS_SET_BOD_LPM()               (SYS->BODCTL |= SYS_BODCTL_BODLPM_Msk)          /*!< This macro set Brown-out detect to low power mode */
#define SYS_SET_BOD_LEVEL(u32Level) (SYS->BODCTL = (SYS->BODCTL & ~SYS_BODCTL_BODVL1_0_Msk) | u32Level) /*!< This macro set Brown-out detect voltage level.u32Level=0~3 */
#define SYS_IS_BOD_RST()                (SYS->RSTSTS & SYS_RSTSTS_BODRF_Msk)        /*!< This macro get previous reset source is from Brown-out detect reset */
#define SYS_IS_CPU_RST()                (SYS->RSTSTS & SYS_RSTSTS_CPURF_Msk)        /*!< This macro get previous reset source is from Low-Voltage-Reset */

#define SYS_IS_POR_RST()                (SYS->RSTSTS & SYS_RSTSTS_PORF_Msk)        /*!< This macro get previous reset source is from Power-on Reset */
#define SYS_IS_RSTPIN_RST()             (SYS->RSTSTS & SYS_RSTSTS_PINRF_Msk)      /*!< This macro get previous reset source is from reset pin reset */
#define SYS_IS_SYSTEM_RST()             (SYS->RSTSTS & SYS_RSTSTS_SYSRF_Msk)        /*!< This macro get previous reset source is from system reset */
#define SYS_IS_WDT_RST()                (SYS->RSTSTS & SYS_RSTSTS_WDTRF_Msk)        /*!< This macro get previous reset source is from window watch dog  reset */
...
#define SYS_CLEAR_RST_SOURCE(u32RstSrc) (SYS->RSTSTS = u32RstSrc )                     /*!< This macro clear reset source flag */
