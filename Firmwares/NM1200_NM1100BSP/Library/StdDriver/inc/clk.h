 ...
 * $Revision: 3 $
 * $Date: 15/06/16 9:11a $ 
 * @brief    NM1200_NM1100 CLK driver header file
 *
 * @note
...
/** @addtogroup NM1200_NM1100_CLK_Driver CLK Driver
  @{
*/



/** @addtogroup NM1200_NM1100_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
#define CLK_CLKSEL1_UART1SEL_HIRC        0x02000000UL /*!< Setting UART1 clock source as external internal RC clock */
...
#define UART1_MODULE      ((0x0<<31)|(0x1<<29)|(0x3<<25)|(24<<20)|(0x0<<18)|(0x0F<<10)|( 8<<5)|CLK_APBCLK_UART1CKEN_Pos)          /*!< UART1 Module */ 
...
/*@}*/ /* end of group NM1200_NM1100_CLK_EXPORTED_CONSTANTS */


/** @addtogroup NM1200_NM1100_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/*@}*/ /* end of group NM1200_NM1100_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1200_NM1100_CLK_Driver */
