...
#define ADC_CHEN_CHEN10_Pos            (10)                                              /*!< ADC_T::CHEN: CHEN10 Position            */
#define ADC_CHEN_CHEN10_Msk            (0x1ul << ADC_CHEN_CHEN10_Pos)                  /*!< ADC_T::CHEN: CHEN10 Mask                */

#define ADC_CHEN_CH10SEL_Pos           (11)                                              /*!< ADC_T::CHEN: CH10SEL Position           */
#define ADC_CHEN_CH10SEL_Msk           (0x3ul << ADC_CHEN_CH10SEL_Pos)                 /*!< ADC_T::CHEN: CH10SEL Mask               */

#define ADC_CMPR0_CMPEN_Pos            (0)                                               /*!< ADC_T::CMPR0: CMPEN Position            */
#define ADC_CMPR0_CMPEN_Msk            (0x1ul << ADC_CMPR0_CMPEN_Pos)                  /*!< ADC_T::CMPR0: CMPEN Mask                */

#define ADC_CMPR0_CMPIE_Pos            (1)                                               /*!< ADC_T::CMPR0: CMPIE Position            */
#define ADC_CMPR0_CMPIE_Msk            (0x1ul << ADC_CMPR0_CMPIE_Pos)                  /*!< ADC_T::CMPR0: CMPIE Mask                */

#define ADC_CMPR0_CMPCOND_Pos          (2)                                               /*!< ADC_T::CMPR0: CMPCOND Position          */
#define ADC_CMPR0_CMPCOND_Msk          (0x1ul << ADC_CMPR0_CMPCOND_Pos)                /*!< ADC_T::CMPR0: CMPCOND Mask              */

#define ADC_CMPR0_CMPCH_Pos            (3)                                               /*!< ADC_T::CMPR0: CMPCH Position            */
#define ADC_CMPR0_CMPCH_Msk            (0xful << ADC_CMPR0_CMPCH_Pos)                  /*!< ADC_T::CMPR0: CMPCH Mask                */

#define ADC_CMPR0_CMPMATCNT_Pos        (8)                                               /*!< ADC_T::CMPR0: CMPMATCNT Position        */
#define ADC_CMPR0_CMPMATCNT_Msk        (0xful << ADC_CMPR0_CMPMATCNT_Pos)              /*!< ADC_T::CMPR0: CMPMATCNT Mask            */

#define ADC_CMPR0_CMPD_Pos             (16)                                              /*!< ADC_T::CMPR0: CMPD Position             */
#define ADC_CMPR0_CMPD_Msk             (0xffful << ADC_CMPR0_CMPD_Pos)                 /*!< ADC_T::CMPR0: CMPD Mask                 */

#define ADC_CMPR1_CMPEN_Pos            (0)                                               /*!< ADC_T::CMPR1: CMPEN Position            */
#define ADC_CMPR1_CMPEN_Msk            (0x1ul << ADC_CMPR1_CMPEN_Pos)                  /*!< ADC_T::CMPR1: CMPEN Mask                */

#define ADC_CMPR1_CMPIE_Pos            (1)                                               /*!< ADC_T::CMPR1: CMPIE Position            */
#define ADC_CMPR1_CMPIE_Msk            (0x1ul << ADC_CMPR1_CMPIE_Pos)                  /*!< ADC_T::CMPR1: CMPIE Mask                */

#define ADC_CMPR1_CMPCOND_Pos          (2)                                               /*!< ADC_T::CMPR1: CMPCOND Position          */
#define ADC_CMPR1_CMPCOND_Msk          (0x1ul << ADC_CMPR1_CMPCOND_Pos)                /*!< ADC_T::CMPR1: CMPCOND Mask              */

#define ADC_CMPR1_CMPCH_Pos            (3)                                               /*!< ADC_T::CMPR1: CMPCH Position            */
#define ADC_CMPR1_CMPCH_Msk            (0xful << ADC_CMPR1_CMPCH_Pos)                  /*!< ADC_T::CMPR1: CMPCH Mask                */

#define ADC_CMPR1_CMPMATCNT_Pos        (8)                                               /*!< ADC_T::CMPR1: CMPMATCNT Position        */
#define ADC_CMPR1_CMPMATCNT_Msk        (0xful << ADC_CMPR1_CMPMATCNT_Pos)              /*!< ADC_T::CMPR1: CMPMATCNT Mask            */

#define ADC_CMPR1_CMPD_Pos             (16)                                              /*!< ADC_T::CMPR1: CMPD Position             */
#define ADC_CMPR1_CMPD_Msk             (0xffful << ADC_CMPR1_CMPD_Pos)                 /*!< ADC_T::CMPR1: CMPD Mask                 */
...
#define ADC_SR_CHANNEL_Msk             (0xful << ADC_SR_CHANNEL_Pos)                   /*!< ADC_T::SR: CHANNEL Mask                 */

#define ADC_SR_VALID_Pos               (8)                                               /*!< ADC_T::SR: VALID Position               */
#define ADC_SR_VALID_Msk               (0x4fful << ADC_SR_VALID_Pos)                   /*!< ADC_T::SR: VALID Mask                   */

#define ADC_SR_OVERRUN_Pos             (20)                                              /*!< ADC_T::SR: OVERRUN Position             */
#define ADC_SR_OVERRUN_Msk             (0x4fful << ADC_SR_OVERRUN_Pos)                 /*!< ADC_T::SR: OVERRUN Mask                 */
...
#define ADC_DELSEL_En2StDelay_Pos     (0)                                               /*!< ADC_T::DELSEL: En2StDelay Position     */
#define ADC_DELSEL_En2StDelay_Msk     (0xfful << ADC_DELSEL_En2StDelay_Pos)          /*!< ADC_T::DELSEL: En2StDelay Mask         */

#define ADC_DELSEL_TMPDMACNT_Pos      (8)                                               /*!< ADC_T::DELSEL: TMPDMACNT Position      */
#define ADC_DELSEL_TMPDMACNT_Msk      (0xfful << ADC_DELSEL_TMPDMACNT_Pos)           /*!< ADC_T::DELSEL: TMPDMACNT Mask          */

#define ADC_DELSEL_ADCSTHOLDCNT_Pos   (16)                                              /*!< ADC_T::DELSEL: ADCSTHOLDCNT Position   */
#define ADC_DELSEL_ADCSTHOLDCNT_Msk   (0xfful << ADC_DELSEL_ADCSTHOLDCNT_Pos)        /*!< ADC_T::DELSEL: ADCSTHOLDCNT Mask       */
...
#define CLK_PD_WK_IS_PD_WK_IS_Pos        (0)                                               /*!< CLK_T::WK_IS: PD_WK_IS Position           */
#define CLK_PD_WK_IS_PD_WK_IS_Msk        (0x1ul << CLK_PD_WK_IS_PD_WK_IS_Pos)              /*!< CLK_T::WK_IS: PD_WK_IS Mask               */
...
typedef struct {
    ...
    */
     ...
     * |        |          |01001 = Connect to TMR0 CH0.
     * |        |          |01010 = Connect to TMR0 CH1.
     * |        |          |01011 = Connect to TMR1 CH0.
     * |        |          |01100 = Connect to TMR1 CH1.
    ...
    */
     ...
     * GCRISR
     * ===================================================================================================
     * Offset: 0x0C  DMA Global Interrupt Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
#define PDMA_BUF_PDMA_BUF_Pos            (0)                                               /*!< PDMA_T::BUF: PDMA_BUF Position            */
#define PDMA_BUF_PDMA_BUF_Msk            (0xfffffffful << PDMA_BUF_PDMA_BUF_Pos)           /*!< PDMA_T::BUF: PDMA_BUF Mask                */
...
#define VDMA_BUF0_VDMA_BUF0_Pos          (0)                                               /*!< VDMA_T::BUF0: VDMA_BUF0 Position          */
#define VDMA_BUF0_VDMA_BUF0_Msk          (0xfffffffful << VDMA_BUF0_VDMA_BUF0_Pos)         /*!< VDMA_T::BUF0: VDMA_BUF0 Mask              */

#define VDMA_BUF1_VDMA_BUF1_Pos          (0)                                               /*!< VDMA_T::BUF1: VDMA_BUF1 Position          */
#define VDMA_BUF1_VDMA_BUF1_Msk          (0xfffffffful << VDMA_BUF1_VDMA_BUF1_Pos)         /*!< VDMA_T::BUF1: VDMA_BUF1 Mask              */
...
#define FMC_ISPCON_SWRST_Pos             (7)                                               /*!< FMC_T::ISPCON: SWRST Position             */
#define FMC_ISPCON_SWRST_Msk             (0x1ul << FMC_ISPCON_SWRST_Pos)                   /*!< FMC_T::ISPCON: SWRST Mask                 */

#define FMC_ISPCON_PT_Pos                (8)                                               /*!< FMC_T::ISPCON: PT Position                */
#define FMC_ISPCON_PT_Msk                (0x7ul << FMC_ISPCON_PT_Pos)                      /*!< FMC_T::ISPCON: PT Mask                    */

#define FMC_ISPCON_ET_Pos                (12)                                              /*!< FMC_T::ISPCON: ET Position                */
#define FMC_ISPCON_ET_Msk                (0x7ul << FMC_ISPCON_ET_Pos)                      /*!< FMC_T::ISPCON: ET Mask                    */
...
typedef struct {
    ...
    */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RSTS_POR  |Reset by Power-On Reset
     ...
     * |[1]     |RSTS_PAD  |Reset by /RESET Pin
     * |        |          |The RSTS_PAD Flag Is Set By The "Reset Signal" From The /RESET Pin To Indicate The Previous Reset Source
     * |        |          |0= No reset from /RESET pin.
     * |        |          |1= The /RESET pin had issued the reset signal to reset the system.
     * |        |          |This bit is cleared by writing 1 to itself.
     * |[2]     |RSTS_WDT  |Reset by Watch-Dog Timer
     * |        |          |The RSTS_WDT Flag Is Set By The "Reset Signal" From The Watch-Dog Timer Module To Indicate The Previous Reset Source
     * |        |          |0= No reset from Watch-Dog Timer.
     * |        |          |1= The Watch-Dog Timer module had issued the reset signal to reset the system.
     * |        |          |This bit is cleared by writing 1 to itself.
     * |[4]     |RSTS_BOD  |Reset by Brown-Out-Detect
     ...
     * |        |          |This bit is cleared by writing 1 to itself.
     * |[5]     |RSTS_SYS  |Reset by Cortex_M0 Kernel
     ...
     * |        |          |1= The Cortex_M0 had issued the reset signal to reset the system by software writing 1 to bit SYSRESTREQ(AIRCR[2], Application Interrupt and Reset Control Register) in system control registers of Cortex_M0 kernel.
     * |        |          |This bit is cleared by writing 1 to itself.
     * |[7]     |RSTS_CPU  |Reset by CPU
     * |        |          |The RSTS_CPU Flag Is Set By Hardware If Software Writes CPU_RST (IPRST_CTL1[1]) "1" To Rest Cortex-M0 CPU Kernel And Flash Memory Controller (FMC)
     * |        |          |0= No reset from CPU.
    ...
    */
     ...
     * IPRST_CTL1
     * ===================================================================================================
     * Offset: 0x08  IP Reset Control Resister 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    */
     ...
     * IPRST_CTL2
     * ===================================================================================================
     * Offset: 0x0C  IP Reset Control Resister 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |1= I2S block reset.
     * |[30]    |SC0_RST   |SC 0 Controller Reset
     * |        |          |0= SC block normal operation.
     * |        |          |1= SC block reset.
     * |[31]    |SC1_RST   |SC 1 Controller Reset
     * |        |          |0= SC block normal operation.
     * |        |          |1= SC block reset.
    */
     ...
     * CPR
     * ===================================================================================================
     * Offset: 0x10  Chip Performance Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |HPE       |High Performance Enable
    ...
    */
     ...
     * BODCTL
     * ===================================================================================================
     * Offset: 0x64  Brown-out Detector Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    */
     ...
     * |        |          |This bit is cleared by writing 1 to itself.
     * |[1]     |BOD17_OUT |Brown-Out Detector Output Status
     * |        |          |0 = Brown-out Detector output status is 0.
     * |        |          |It means the detected voltage is higher than target detected voltage setting.
     * |        |          |1 = Brown-out Detector output status is 1.
     * |        |          |It means the detected voltage is lower than target detected voltage setting (1.7V).
     * |        |          |If the BOD17_EN is "0", BOD17 function disabled, this bit always responds "0".
     * |[2]     |BOD20_OUT |Brown-Out Detector Output Status
     * |        |          |0 = Brown-out Detector output status is 0.
     * |        |          |It means the detected voltage is higher than target detected voltage setting.
     * |        |          |1 = Brown-out Detector output status is 1.
     * |        |          |It means the detected voltage is lower than target detected voltage setting (2.0 V).
     * |        |          |If the BOD20_EN is "0", BOD20 function disabled, this bit always responds "0".
     * |[3]     |BOD25_OUT |Brown-Out Detector Output Status
     * |        |          |0 = Brown-out Detector output status is 0.
     * |        |          |It means the detected voltage is higher than target detected voltage setting.
     * |        |          |1 = Brown-out Detector output status is 1.
     * |        |          |It means the detected voltage is lower than target detected voltage setting (2.5 V).
     * |        |          |If the BOD25_EN is "0", BOD25 function disabled, this bit always responds "0".
    */
     ...
     * |        |          |User must enable band-gap if want to enable internal 1.5V or 2.5V reference voltage.
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     ...
     * |[11:8]  |BGP_TRIM  |Band-Gap Trim Value
     * |        |          |This is a protected register. Please refer to open lock sequence to program it.
     * |        |          |It is used to modify Band-gap output voltage.
     * |        |          |Each step can adjust 2 % of band-gap output voltage.
     * |        |          |The higher value, the lower band-gap output voltage.
    */
    ...
    */
     ...
     * |        |          |0 = 2K_ERR_INT status Disabled 3to trigger an interrupt to CPU.
    ...
    */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RegUnLock |Protected Register Unlock Status
...
/**
    @addtogroup SYS_CONST GCR Bit Field Definition
...
#define SYS_RST_SRC_RSTS_SYS_Pos         (5)                                               /*!< SYS_T::RST_SRC: RSTS_SYS Position             */
#define SYS_RST_SRC_RSTS_SYS_Msk         (0x1ul << SYS_RST_SRC_RSTS_SYS_Pos)               /*!< SYS_T::RST_SRC: RSTS_SYS Mask                 */
...
#define SYS_CPR_HPE_Pos                  (0)                                               /*!< SYS_T::CPR: HPE Position         */
#define SYS_CPR_HPE_Msk                  (0x1ul << SYS_CPR_HPE_Pos)                        /*!< SYS_T::CPR: HPE Mask             */
...
#define SYS_BODSTS_BOD17_OUT_Pos         (1)                                               /*!< SYS_T::BODSTS: BOD17_OUT Position        */
#define SYS_BODSTS_BOD17_OUT_Msk         (0x1ul << SYS_BODSTS_BOD17_OUT_Pos)               /*!< SYS_T::BODSTS: BOD17_OUT Mask            */

#define SYS_BODSTS_BOD20_OUT_Pos        (2)                                               /*!< SYS_T::BODSTS: BOD20_OUT Position        */
#define SYS_BODSTS_BOD20_OUT_Msk        (0x1ul << SYS_BODSTS_BOD20_OUT_Pos)               /*!< SYS_T::BODSTS: BOD20_OUT Mask            */

#define SYS_BODSTS_BOD25_OUT_Pos         (3)                                               /*!< SYS_T::BODSTS: BOD25_OUT Position        */
#define SYS_BODSTS_BOD25_OUT_Msk         (0x1ul << SYS_BODSTS_BOD25_OUT_Pos)               /*!< SYS_T::BODSTS: BOD25_OUT Mask            */
...
typedef struct {
    ...
    */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |PUEN      |GPIO Port [X] Pin [N] Pull-Up Enable Bit
     * |        |          |0 = GPIO port [A/B/C/D/E/F] bit [n] pull-up resistor is disabled.
     * |        |          |1 = GPIO port [A/B/C/D/E/F] bit [n] pull-up resistor is enabled.
     * |        |          |Note: For GPIOF_PUEN, bits [15:6] and [3:2] are reserved.
    */
    __IO uint32_t PUEN;
...
typedef struct {
    ...
    */
     ...
     * |        |          |0 = No receiving interrupt occurs.
     * |        |          |1 = Receiving interrupt occurs.
     * |        |          |This bit is read only
     * |[2]     |I2STXINT  |I2S Transmit Interrupt
     * |        |          |0 = No transmit interrupt occurs.
     ...
     * |        |          |1 = Data word(s) in transmitting FIFO is equal or lower than threshold level.
     * |        |          |This bit is read only
     ...
     * |        |          |This bit is clear to 0 when all data in the transmitting FIFO and shift buffer is shifted out.
...
typedef struct {
    ...
    */
     ...
     * OE
     * ===================================================================================================
     * Offset: 0x14  PWM Output Enable Register for CH0 ~ CH3
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
typedef struct {
     ...
     * |[31:0]  |INIR      |RTC Initiation (Write Only)
    ...
    */
     ...
     * |[6:4]   |10SEC     |10 Sec Time Digit (0~9)
    ...
    */
     ...
     * |[6:4]   |10SEC     |10 Sec Time Digit of Alarm Setting (0~9)
     ...
     * |[21:20] |10HR      |10 Hour Time Digit of Alarm Setting (0~3)2
    */
    __IO uint32_t TAR;
    ...
    */
     ...
     * |        |          |RTC unit will set AIF to high once the RTC real time counters TLR and CLR reach the alarm setting time registers TAR and CAR.
     ...
     * |        |          |1 = Indicates RTC Time Tick Interrupt is requested.
     * |[2]     |SNOOPIS   |Snooper Pin Event Detection Interrupt Status
...
#define RTC_TSSR_24H_12H_Msk             (0x1ul << RTC_TSSR_24H_12H_Pos)                 /*!< RTC_T::TSSR: 24H_12H Mask               */
...
typedef struct {
     ...
     * |        |          |Setting this bit to "1" to enable SC operation.
     ...
     * |        |          |If software enables auto convention function, the setting step must be done before Answer to Request state and the first data must be 0x3B or 0x3F.
...
#define SC_IER_COMPEN_EN_Pos             (15)                                              /*!< SC_T::IER: COMPEN_EN Position             */
#define SC_IER_COMPEN_EN_Msk             (0x1ul << SC_IER_COMPEN_EN_Pos)                   /*!< SC_T::IER: COMPEN_EN Mask                 */
...
#define SPI_CTL_TX_NUM_Pos               (8)                                               /*!< SPI_T::CTL: TX_NUM Position               */
#define SPI_CTL_TX_NUM_Msk               (0x3ul << SPI_CTL_TX_NUM_Pos)                     /*!< SPI_T::CTL: TX_NUM Mask                   */
...
#define SPI_CTL_REORDER_Msk              (0x3ul << SPI_CTL_REORDER_Pos)                    /*!< SPI_T::CTL: REORDER Mask                  */
...
#define SPI_CLKDIV_DIVIDER1_Msk          (0xfffful << SPI_CLKDIV_DIVIDER1_Pos)             /*!< SPI_T::CLKDIV: DIVIDER1 Mask              */

#define SPI_CLKDIV_DIVIDER2_Pos          (16)                                              /*!< SPI_T::CLKDIV: DIVIDER2 Position          */
#define SPI_CLKDIV_DIVIDER2_Msk          (0xfffful << SPI_CLKDIV_DIVIDER2_Pos)             /*!< SPI_T::CLKDIV: DIVIDER2 Mask              */
...
#define SPI_PDMA_TX_DMA_EN_Pos           (0)                                               /*!< SPI_T::PDMA: TX_DMA_EN Position           */
#define SPI_PDMA_TX_DMA_EN_Msk           (0x1ul << SPI_PDMA_TX_DMA_EN_Pos)                 /*!< SPI_T::PDMA: TX_DMA_EN Mask               */

#define SPI_PDMA_RX_DMA_EN_Pos           (1)                                               /*!< SPI_T::PDMA: RX_DMA_EN Position           */
#define SPI_PDMA_RX_DMA_EN_Msk           (0x1ul << SPI_PDMA_RX_DMA_EN_Pos)                 /*!< SPI_T::PDMA: RX_DMA_EN Mask               */

#define SPI_PDMA_PDMA_RST_Pos            (2)                                               /*!< SPI_T::PDMA: PDMA_RST Position            */
#define SPI_PDMA_PDMA_RST_Msk            (0x1ul << SPI_PDMA_PDMA_RST_Pos)                  /*!< SPI_T::PDMA: PDMA_RST Mask                */

#define SPI_FFCLR_RX_CLR_Pos             (0)                                               /*!< SPI_T::FFCLR: RX_CLR Position             */
#define SPI_FFCLR_RX_CLR_Msk             (0x1ul << SPI_FFCLR_RX_CLR_Pos)                   /*!< SPI_T::FFCLR: RX_CLR Mask                 */

#define SPI_FFCLR_TX_CLR_Pos             (1)                                               /*!< SPI_T::FFCLR: TX_CLR Position             */
#define SPI_FFCLR_TX_CLR_Msk             (0x1ul << SPI_FFCLR_TX_CLR_Pos)                   /*!< SPI_T::FFCLR: TX_CLR Mask                 */
...
typedef struct {
     ...
     * |        |          |0 = Receiver Enabled.
     * |        |          |1 = Receiver Disabled.
     * |        |          |Note1: When using for RS-485 NMM mode, user can setting this bit to receive data or not that before detect address byte.
     * |        |          |Note2: In RS-485 NMM mode, this bit will be setting to "1" automatically.
     * |        |          |Note3: In RS-485 AAD mode and LIN "break + sync +PID" header mode, hardware will control data automatically, so don't fill any value to this bit.
     ...
     * |        |          |0 = RX PDMA service function Enabled.
     * |        |          |1 = RX PDMA service function Disabled.
     * |[7]     |DMA_TX_EN |TX DMA Enable
     * |        |          |This bit can enable or disable TX PDMA service.
     * |        |          |0 = TX PDMA service function Enabled.
     * |        |          |1 = TX PDMA service function Disabled.
    ...
    */
     ...
     * |        |          |1 = 1.5 STOP bit is generated in the transmitted data when 5-bit word length is selected, and 2 STOP bit is generated when 6, 7 and 8 bit data length is selected.
     ...
     * |        |          |When the number of bytes in the receiving FIFO equals to the RFITL then the RDA_IF will be set (if IER [RDA_IEN] is enabled, an interrupt will be generated)
     * |        |          |00 = INTR_RDA Trigger Level 1 byte.
    ...
    */
     ...
     * |        |          |Note2: This bit is cleared when both that the BI_F, FE_F, PE_F and RS-485_ADDET_F are cleared.
     ...
     * |        |          |Note2: This bit is cleared when both that the TX_OVER_F and RX_OVER_F are cleared.
     ...
     * |        |          |Note2: This bit is cleared when both that the ABAUD_TOUT_F and ABAUD_F are cleared.
     ...
     * |        |          |Note2: This bit is cleared when both that the BIT_ERR_F, BIT_TX_F and LIN_RX_F are cleared.
    */
    __IO  uint32_t ISR;
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RS_485_ADDET_F|RS-485 Address Byte Detection Status Flag (Read Only)
    ...
    */
     ...
     * MCSR
     * ===================================================================================================
     * Offset: 0x1C  UART Modem Status Register.
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    */
     ...
     * |        |          |Note4: The UART data format is start bit + 8 bit data + parity bit + stop bit, so although software can configure this field by any value but it is recommend to filled this field great than 0xA.
    ...
    */
     ...
     * |[16]    |RS_485_NMM|RS-485 Normal Multi-Drop Operation Mode (RS-485 NMM Mode)
     ...
     * |[17]    |RS_485_AAD|RS-485 Auto Address Detection Operation Mode (RS-485 AAD Mode)
     ...
     * |[18]    |RS_485_AUD|RS-485 Auto Direction Mode (RS-485 AUD Mode)
     ...
     * |[19]    |RS_485_ADD_EN|RS-485 Address Detection Enable
     * |        |          |This bit is used to enable RS-485 hardware address detection mode.
     * |        |          |If hardware detects address byte, and then the controller will set UART_TRSR [RS_485_ADDET_F] = "1".
...
typedef struct {
     ...
     * BUFSEGn
     * ===================================================================================================
     * Offset: 0x20 + n * 0x10  Endpoint n Buffer Segmentation Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    */
     ...
     * MXPLDn
     * ===================================================================================================
     * Offset: 0x24 + n * 0x10  Endpoint n Maximal Payload Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
    ...
    */
     ...
     * CFGn
     * ===================================================================================================
     * Offset: 0x28 + n * 0x10  Endpoint n Configuration Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
...
#define USBD_CFG_EPMODE_Pos              (5)                                               /*!< USBD_EP_T::CFG: EPMODE Position             */
#define USBD_CFG_EPMODE_Msk              (0x3ul << USBD_CFG_EPMODE_Pos)                    /*!< USBD_EP_T::CFG: EPMODE Mask                 */

#define USBD_CFG_DSQ_SYNC_Pos            (7)                                               /*!< USBD_EP_T::CFG: DSQ_SYNC Position           */
#define USBD_CFG_DSQ_SYNC_Msk            (0x1ul << USBD_CFG_DSQ_SYNC_Pos)                  /*!< USBD_EP_T::CFG: DSQ_SYNC Mask               */

#define USBD_CFG_CSTALL_Pos              (8)                                               /*!< USBD_EP_T::CFG: CSTALL Position             */
#define USBD_CFG_CSTALL_Msk              (0x1ul << USBD_CFG_CSTALL_Pos)                    /*!< USBD_EP_T::CFG: CSTALL Mask                 */

#define USBD_CFG_SSTALL_Pos              (9)                                               /*!< USBD_EP_T::CFG: SSTALL Position             */
#define USBD_CFG_SSTALL_Msk              (0x1ul << USBD_CFG_SSTALL_Pos)                    /*!< USBD_EP_T::CFG: SSTALL Mask                 */

#define USBD_CFG_CLRRDY_Pos              (15)                                              /*!< USBD_EP_T::CFG: CLRRDY Position             */
#define USBD_CFG_CLRRDY_Msk              (0x1ul << USBD_CFG_CLRRDY_Pos)                    /*!< USBD_EP_T::CFG: CLRRDY Mask                 */
...
#define PDMAGCR_BASE          (AHBPERIPH_BASE + 0x08F00)     ///< PDMA GCR register base address
