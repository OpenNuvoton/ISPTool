...
/**
  * @brief This function is used to configure timer to operate in specified mode
  ...
  * @note After calling this function, Timer is \b NOT running yet. But could start timer running be calling
...
/**
  * @brief This function stops Timer counting and disable the Timer interrupt function
  * @param[in] timer The base address of Timer module
  * @return None
  */
...
/**
  * @brief This function is used to create a delay loop for u32usec micro seconds
  * @param[in] timer The base address of Timer module
  ...
  * @return None
  * @note This function overwrites the register setting of the timer used to count the delay time.
  * @note This function use polling mode. So there is no need to enable interrupt for the timer module used to generate delay
  */
...
/**
  * @brief This function is used to enable timer capture function with specified mode and capture edge
  * @param[in] timer The base address of Timer module
  ...
  * @return None
  * @note Timer frequency should be configured separately by using \ref TIMER_Open function, or program registers directly
  */
...
/**
  * @brief This function is used to disable the Timer capture function
  * @param[in] timer The base address of Timer module
  * @return None
  */
...
/**
  * @brief This function is used to disable the Timer event counter function.
  * @param[in] timer The base address of Timer module
  * @return None
  */
...
/**
  * @brief This function is used to get the clock frequency of Timer
  * @param[in] timer The base address of Timer module
  * @return Timer clock frequency
  * @note This function cannot return correct clock rate if timer source is external clock input.
  */
