 ...
 * @version  V3.00
 * $Revision: 6 $
 * $Date: 17/05/19 11:49a $
 * @brief    NM1120 series GPIO driver header file
 *
 * @note
...
/** @addtogroup NM1120_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1120_GPIO_EXPORTED_CONSTANTS */
