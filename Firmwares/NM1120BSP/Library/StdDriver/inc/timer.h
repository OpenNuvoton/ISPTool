 ...
 * $Revision: 5 $
 * $Date: 16/07/12 1:52p $
 * @brief    NM1120 TIMER driver header file
 *
 * @note
...
/** @addtogroup NM1120_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup NM1120_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1120_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup NM1120_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group NM1120_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1120_TIMER_Driver */
