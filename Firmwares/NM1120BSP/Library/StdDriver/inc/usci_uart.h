 ...
 * $Revision: 15 $
 * $Date: 16/07/12 2:02p $
 * @brief    NM1120 USCI UART (UUART) driver header file
 *
 * @note
...
/** @addtogroup NM1120_USCI_UART_Driver UUART Driver (USCI UART Mode Driver)
  @{
*/

/** @addtogroup NM1120_USCI_UART_EXPORTED_CONSTANTS UUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1120_USCI_UART_EXPORTED_CONSTANTS */


/** @addtogroup NM1120_USCI_UART_EXPORTED_FUNCTIONS UUART Exported Functions
  @{
*/
...
/*@}*/ /* end of group NM1120_USCI_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1120_USCI_UART_Driver */
