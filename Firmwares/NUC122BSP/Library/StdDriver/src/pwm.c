                                  ...
                                  uint32_t u32CaptureEdge)
{
    ...
    uint32_t u32PWMClkTbl[4] = {__HXT, __LXT, NULL, __HIRC};
    ...
    if(u32ChannelNum < 2)/* channel 0 and channel 1 */
        u32Src = (CLK->CLKSEL1 & (CLK_CLKSEL1_PWM01_S_Msk)) >> (CLK_CLKSEL1_PWM01_S_Pos);
    else /* channel 2 and channel 3 */
        u32Src = (CLK->CLKSEL1 & (CLK_CLKSEL1_PWM23_S_Msk)) >> (CLK_CLKSEL1_PWM23_S_Pos);
