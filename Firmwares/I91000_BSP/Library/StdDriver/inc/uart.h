 ...
 * $Revision: 2 $
 * $Date: 15/09/24 2:50p $
 * @brief    ISD9000 Series UART driver header file
 *
 * @note
...
/** @addtogroup ISD9000_UART_Driver UART Driver
  @{
*/

/** @addtogroup ISD9000_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9000_UART_EXPORTED_CONSTANTS */


/** @addtogroup ISD9000_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9000_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9000_UART_Driver */
