...
#ifndef __SYSTEM_ISD9000_H__
#define __SYSTEM_ISD9000_H__
...
#define __HIRC        (49152000UL)  /*!< High Speed Internal 49MHz RC Oscillator Frequency */
#define __HSI         (__HIRC)      /* Factory Default is internal 23MHz */
