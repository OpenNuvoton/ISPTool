...
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_CHAN0_COMP_OUTPUT                    (PWM_CTL1_CNTMODE0_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */
#define PWM_CHAN2_COMP_OUTPUT                    (PWM_CTL1_CNTMODE2_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */
#define PWM_CHAN4_COMP_OUTPUT                    (PWM_CTL1_CNTMODE4_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */
 ...
 * \hideinitializer
 */
#define PWM_ENABLE_COMPLEMENTARY_MODE(pwm) ((pwm)->CTL1 |= (PWM_CTL1_CNTMODE0_Msk|PWM_CTL1_CNTMODE2_Msk|PWM_CTL1_CNTMODE4_Msk))
 ...
 * \hideinitializer
 */
#define PWM_DISABLE_COMPLEMENTARY_MODE(pwm) ((pwm)->CTL1 &= ~(PWM_CTL1_CNTMODE0_Msk|PWM_CTL1_CNTMODE2_Msk|PWM_CTL1_CNTMODE4_Msk))
