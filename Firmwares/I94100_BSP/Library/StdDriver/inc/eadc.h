...
/**
  ...
  *                          This parameter decides which sample module interrupts will be enabled, valid range are between bit 0 ~ bit 17.
  * @return None
...
/**
  ...
  * @param[in] u32IntSel Decides which interrupt source will be used, valid value are from 0 to 3.
  * @param[in] u32ModuleMask the combination of sample module interrupt status bits. Each bit corresponds to a sample module interrupt status.
  *                          This parameter decides which sample module interrupts will be disabled, valid range are between bit 0 ~ bit 17.
  * @return None
  * @details There are 4 ADC interrupts ADINT0~3, and each of these interrupts has its own interrupt vector address.
  */
...
/**
  ...
  *                         This parameter decides which sample module will be conversion, valid range are between bit 0 ~ bit 17.
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module. Each bit corresponds to a sample module.
  *                         This parameter decides which sample module will stop the conversion, valid range are between bit 0 ~ bit 17.
  *                         Bit 0 is sample module 0, bit 1 is sample module 1..., bit 17 is sample module17.
  * @return None
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module overrun status bits. Each bit corresponds to a sample module overrun status, valid range are between bit 0 ~ bit 17.
...
/**
  ...
  *                      Bit 0 is SPOVF0, bit 1 is SPOVF1..., bit 17 is SPOVF18.
  * @return None
