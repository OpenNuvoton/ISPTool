 ...
 * @brief    M4521 SPI driver source file
 *
 * @note
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @param[in]  u32TxThreshold Decides the TX FIFO threshold. For SPI0, it could be 0 ~ 7. For SPI1, it could be 0 ~ 3.
  * @param[in]  u32RxThreshold Decides the RX FIFO threshold. For SPI0, it could be 0 ~ 7. For SPI1, it could be 0 ~ 3.
  * @return None
...
/**
  ...
  * @details Return the source clock frequency according to the setting of SPI1SEL (CLKSEL2[5:4]).
  * @note   Only SPI1 support I2S mode.
  */
...
//        u32Divider = (u32SrcClk / u32BusClock) >> 1;
        u32Divider = (((u32SrcClk * 10UL / u32BusClock) >> 1) + 5UL) / 10UL;
