...
#define MDU_RST     ((0x4<<24) | SYS_IPRSTC2_MDU_RST_Pos )      /*!< MDU reset is one of the SYS_ResetModule parameter */
...
#define CAN_RST     ((0x4<<24) | SYS_IPRSTC2_CAN_RST_Pos )      /*!< CAN reset is one of the SYS_ResetModule parameter */
...
#define QEI0_RST    ((0x4<<24) | SYS_IPRSTC2_QEI0_RST_Pos )     /*!< QEI0 reset is one of the SYS_ResetModule parameter */
#define QEI1_RST    ((0x4<<24) | SYS_IPRSTC2_QEI1_RST_Pos )     /*!< QEI1 reset is one of the SYS_ResetModule parameter */
...
#define SYS_MFP_P24_QEI0_A          0x00000010UL    /*!< P2_MFP pin 4 setting for QEI0_A      */
#define SYS_MFP_P24_CAN_RXD         0x00001010UL   /*!< P2_MFP pin 4 setting for CAN_RXD     */
#define SYS_MFP_P24_Msk             0x00001010UL    /*!< P2_MFP pin 4 Msk                     */

#define SYS_MFP_P25_GPIO            0x00000000UL    /*!< P2_MFP pin 5 setting for GPIO        */
#define SYS_MFP_P25_QEI0_B          0x00000020UL    /*!< P2_MFP pin 5 setting for QEI0_B      */
#define SYS_MFP_P25_CAN_TXD         0x00002020UL    /*!< P2_MFP pin 5 setting for CAN_TXD     */
#define SYS_MFP_P25_Msk             0x00002020UL    /*!< P2_MFP pin 5 Msk                     */

#define SYS_MFP_P26_GPIO            0x00000000UL    /*!< P2_MFP pin 6 setting for GPIO        */
#define SYS_MFP_P26_QEI0_Z          0x00000040UL    /*!< P2_MFP pin 6 setting for QEI0_Z      */
...
#define SYS_MFP_P36_CAN_RXD         0x00000040UL    /*!< P3_MFP pin 6 setting for CAN_RXD     */
#define SYS_MFP_P36_Msk             0x00000040UL    /*!< P3_MFP pin 6 Msk                     */

#define SYS_MFP_P37_GPIO            0x00000000UL    /*!< P3_MFP pin 7 setting for GPIO        */
#define SYS_MFP_P37_CAN_TXD         0x00000080UL    /*!< P3_MFP pin 7 setting for CAN_TXD     */
...
#define SYS_MFP_P44_QEI1_A          0x00000010UL    /*!< P4_MFP pin 4 setting for QEI1_A      */
#define SYS_MFP_P44_Msk             0x00000010UL    /*!< P4_MFP pin 4 Msk                     */

#define SYS_MFP_P45_GPIO            0x00000000UL    /*!< P4_MFP pin 5 setting for GPIO        */
#define SYS_MFP_P45_QEI1_B          0x00000020UL    /*!< P4_MFP pin 5 setting for QEI1_B      */
...
#define SYS_MFP_P46_QEI1_Z          0x00004000UL    /*!< P4_MFP pin 6 setting for QEI1_Z      */
