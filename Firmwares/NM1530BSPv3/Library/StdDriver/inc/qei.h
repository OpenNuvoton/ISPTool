...
/*---------------------------------------------------------------------------------------------------------*/
#define QEI_CTL_NFCLKSEL_QEI_CLK        (0x0<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK */
...
/**
  ...
  */
#define QEI_CLEAR_INT_FLAG(qei, u32IntSel)     ((qei)->STATUS = (u32IntSel))
...
/**
  * @brief      Set QEI counter hold mode
  * @param[in]  qei         The pointer of the specified QEI module.
  ...
  */
#define QEI_SET_HOLD_TRG_SRC(qei, u32Type)      ((qei)->CTL = (u32Type))
