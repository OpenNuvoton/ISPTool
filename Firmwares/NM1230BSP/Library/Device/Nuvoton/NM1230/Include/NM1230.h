...
/**
  * \page pg1 NuMicro NM1230 BSP Directory Structure
  * Please refer to "Readme.pdf" under BSP root directory for the BSP directory structure
  *
  * \page pg2 Revision History
  * Please refer to "NuMicro NM1230 CMSIS BSP Revision History.pdf" under BSP\\Document directory for the BSP Revision History
  *
*/
...
#include "system_NM1230.h"              /* NM1230 System                                          */
 ...
 * |        |          |When the IRQ[n] is 1 (i.e
 * |        |          |an interrupt is assert), setting 1 to the MCU_bit[n] will clear the interrupt and setting IRQ[n] 0 has no effect.
 */
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[11]    |HARDFAULRF|Hard fault reset Flag
 ...
 * |[6]     |QEIRST    |QEI Controller Reset
 * |        |          |0 = QEI controller normal operation.
 * |        |          |1 = QEI controller reset.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[1]     |TFAILIEN  |Trim Failure Interrupt Enable Control
...
#define SYS_RSTSTS_HARDFAULRF_Pos        (11)                                              /*!< SYS_T::RSTSTS: HARDFAULRF Position     */
#define SYS_RSTSTS_HARDFAULRF_Msk        (0x1ul << SYS_RSTSTS_HARDFAULRF_Pos)              /*!< SYS_T::RSTSTS: HARDFAULRF Mask         */
...
#define SYS_IPRST1_QEIRST_Pos            (6)                                               /*!< SYS_T::IPRST1: QEIRST Position         */
#define SYS_IPRST1_QEIRST_Msk            (0x1ul << SYS_IPRST1_QEIRST_Pos)                  /*!< SYS_T::IPRST1: QEIRST Mask             */
 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[15:14] |PD_MODE   |00: LDO off when power down mode
 * |        |          |01: LDO on when power down node
 * |[24]    |HIRC_SEL  |0: Set HIRC to 48MHz
 * |        |          |1: Set HIRC to 72MHz
 * @var CLK_T::AHBCLK
 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[1]     |QEICKEN   |QEI Clock Enable Control
 * |        |          |0 = QEI clock Disabled.
 * |        |          |1 = QEI clock Enabled.
 ...
 * |        |          |1 = CAP clock Enabled.
 * |[12]    |PGACKEN   |PGA Clock Enable Control
 ...
 * |[24]    |USCI0CKEN |USCI0 Clock Enable Control
 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[5:4]   |ADCSEL    |ADC Peripheral Clock Source Selection
 * |        |          |00 = Clock source from external crystal oscillator (HXT or LXT).
 * |        |          |01 = Reserved.
 ...
 * |        |          |111 = Clock source from 48 MHz internal high speed RC oscillator (HIRC).
 * |        |          |Others = Reserved.
 * |[18:16] |TMR2SEL   |TIMER0 Clock Source Selection
 * |        |          |000 = Clock source from external crystal oscillator (HXT or LXT).
 * |        |          |001 = Clock source from 10 kHz internal low speed RC oscillator (LIRC).
 * |        |          |010 = Clock source from HCLK.
 * |        |          |011 = Clock source from external clock T0 pin.
 * |        |          |111 = Clock source from 48 MHz internal high speed RC oscillator (HIRC).
 * |        |          |Others = Reserved.
 * |[22:20] |TMR3SEL   |TIMER1 Clock Source Selection
 * |        |          |000 = Clock source from external crystal oscillator (HXT or LXT).
 * |        |          |001 = Clock source from 10 kHz internal low speed RC oscillator (LIRC).
 * |        |          |010 = Clock source from HCLK.
 * |        |          |011 = Clock source from external clock T1 pin.
...
#define CLK_AHBCLK_CRC16CKEN_Pos         (4)                                               /*!< CLK_T::AHBCLK: CRC16CKEN Position      */
#define CLK_AHBCLK_CRC16CKEN_Msk         (0x1ul << CLK_AHBCLK_CRC16CKEN_Pos)               /*!< CLK_T::AHBCLK: CRC16CKEN Mask          */
...
#define CLK_APBCLK_QEICKEN_Pos           (1)                                               /*!< CLK_T::APBCLK: QEICKEN Position        */
#define CLK_APBCLK_QEICKEN_Msk           (0x1ul << CLK_APBCLK_QEICKEN_Pos)                 /*!< CLK_T::APBCLK: QEICKEN Mask            */
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |DBEN0     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |DBEN1     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |DBEN2     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |DBEN3     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |DBEN4     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |DBEN5     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |DBEN6     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |DBEN7     |Port A-D Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |0 = PD.2.
 * |        |          |1 = PC.2.
 * |[7:5]   |CNTSEL23  |Capture Timer23 Selection
 * |        |          |000 = TIMER2
 * |        |          |001 = TIMER3
...
#define TIMER_CCAPCTL_CNTSEL23_Pos         (5)                                               /*!< TIMER_AC_T::CCAPCTL: CNTSEL Position        */
#define TIMER_CCAPCTL_CNTSEL23_Msk         (0x7ul << TIMER_CCAPCTL_CNTSEL23_Pos)             /*!< TIMER_AC_T::CCAPCTL: CNTSEL Mask            */
 ...
 * |        |          |11 = CAP0 input is from signal ADC_CPR (ADC compare output).
 ...
 * |        |          |11 = CAP1 input is from signal ADC_CPR (ADC compare output).
 ...
 * |        |          |11 = CAP2 input is from signal ADC_CPR (ADC compare output).
 ...
 * |        |          |1 = The   un-synchronized input signal will be inverted.
 * @var UUART_T::CTLIN1
 * Offset: 0x24  USCI Input Control Signal Configuration Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var UUART_T::CLKIN
 ...
 */
    ...
    __IO uint32_t CTLIN1;                /*!< [0x0024] USCI Input Control Signal Configuration Register 0               */
...
/**
    @addtogroup CRC16 Cyclic Redundancy Check(CRC16)
    Memory Mapped Structure for CRC16 Controller
@{ */
...
/**
 * @var CRC16_T::CTL
 * Offset: 0x80  CRC16 Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |SEED      |CRC Seed Data
 ...
 * |[25:16] |CNT       |Byte Length
 * |[30]    |BITORD    |Bit order
 * |        |          |0: [0:7]
 * |        |          |1: [7:0]
 * |[31]    |BYTEORD   |Byte order
 * |        |          |0: Big endian
 * |        |          |1: Little endian
 * @var CRC16_T::DIN
 * Offset: 0x84  CRC16 Data in Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |DIN       |CRC Data in
 * |        |          |This register was provided to be the initial value for CRC operation.
 * |        |          |Write data to this register before ISP CRC operation.
 * |        |          |Read data from this register after ISP CRC read operation.
 * @var CRC16_T::OUT
 * Offset: 0x88  CRC16 Result Value Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |RESULT    |CRC Result Value
 * |        |          |This register provided current value of CRC durning calculation.
 */

    __IO uint32_t CTL;                   /*!< [0x0000] CRC16 Control Register                                              */
    __IO uint32_t DIN;                   /*!< [0x0004] CRC16 Data in Register                                              */
    __I  uint32_t OUT;                   /*!< [0x0008] CRC16 Result Value Register                                         */

} CRC16_T;


/**
    @addtogroup CRC16_CONST CRC16 Bit Field Definition
    Constant Definitions for CRC16 Controller
@{ */

#define CRC16_CTL_SEED_Pos               (0)                                               /*!< CRC16_T::SEED: SEED Position           */
#define CRC16_CTL_SEED_Msk               (0xfffful << CRC16_CTL_SEED_Pos)                  /*!< CRC16_T::SEED: SEED Mask               */

#define CRC16_CTL_CNT_Pos                (16)                                              /*!< CRC16_T::SEED: BYTECNT Position        */
#define CRC16_CTL_CNT_Msk                (0x3fful << CRC16_CTL_CNT_Pos)                    /*!< CRC16_T::SEED: BYTECNT Mask            */

#define CRC16_CTL_BITORD_Pos             (30)                                              /*!< CRC16_T::SEED: BITORD Position         */
#define CRC16_CTL_BITORD_Msk             (0x1ul << CRC16_CTL_BITORD_Pos)                   /*!< CRC16_T::SEED: BITORD Mask             */

#define CRC16_CTL_BYTEORD_Pos            (31)                                              /*!< CRC16_T::SEED: BYTEORD Position        */
#define CRC16_CTL_BYTEORD_Msk            (0x1ul << CRC16_CTL_BYTEORD_Pos)                  /*!< CRC16_T::SEED: BYTEORD Mask            */

#define CRC16_DIN_DIN_Pos                (0)                                               /*!< CRC16_T::DIN: DIN Position             */
#define CRC16_DIN_DIN_Msk                (0xfffffffful << CRC16_DIN_DIN_Pos)               /*!< CRC16_T::DIN: DIN Mask                 */

#define CRC16_OUT_RESULT_Pos             (0)                                               /*!< CRC16_T::OUT: RESULT Position          */
#define CRC16_OUT_RESULT_Msk             (0xfffful << CRC16_OUT_RESULT_Pos)                /*!< CRC16_T::OUT: RESULT Mask              */

/**@}*/ /* CRC16_CONST */
/**@}*/ /* end of CRC16 register group */
 ...
 * |[3]     |BRK0A1EN  |BRK0 Source From ACMP1 Enable Control
 * |        |          |0 = BRK0 Source From ACMP1 Disabled.
 * |        |          |1 = BRK0 Source From ACMP1 Enabled.
 ...
 * |[11]    |BRK1A1EN  |BRK1 Source From ACMP1 Enable Control
 * |        |          |0 = BRK1 Source From ACMP1 Disabled.
 * |        |          |1 = BRK1 Source From ACMP1 Enabled.
 ...
 * |        |          |010 = Triggered by CAPPHG_TRG from ECAP.
 ...
 * |[29]    |ACMP1TEN  |ACMP1 Trigger Function Enable Control
 ...
 * |        |          |Note1: Interrupt is generated if ACMPIE bit is set to "1" after ACMP conversion is finished.
 * |        |          |Note2: ACMP interrupt will wake CPU up in Power-down mode.
 * |[3:2]   |ACMPHYSEN |Comparator1 Hysteresis Enable Control (Only 20mV)
 * |        |          |00 = ACMP0 Hysteresis function Disabled (Default).
 * |        |          |01 = ACMP0 Hysteresis function at comparator 0 Enabled that the typical range is 10mV.
 * |        |          |10 = ACMP0 Hysteresis function at comparator 0 Enabled that the typical range is 90mV.
 * |        |          |11 = ACMP0 Hysteresis function Disabled.
 * |[5:4]   |EDGESEL   |Interrupt Flag Trigger Edge Detection
 * |        |          |00 = Interrupt Flag Trigger Edge Detection Disable.
 * |        |          |01 = Rising.
 * |        |          |10 = Falling.
 * |        |          |11 = Rising/Falling.
 * |[6]     |PBRKSEL   |ACMP to EPWM Brake Selection
 ...
 * |        |          |0 = Analog Comparator Delay Trigger Mode Interrupt Disabled.
 * |        |          |1 = Analog Comparator Delay Trigger Mode Interrupt Enabled.
 * |[15:14] |DLYEDGESEL|Interrupt Flag Trigger Edge Detection
 * |        |          |00 = Interrupt Flag Trigger Edge Detection Disable.
 * |        |          |01 = Rising.
 * |        |          |10 = Falling.
 * |        |          |11 = Rising/Falling.
 ...
 * |[25:24] |CPNSEL    |Comparator Negative Input Selection
 * |        |          |00 = ACMP1_N (PB.3).
 * |        |          |01 = Band_Gap.
 * |        |          |10 = CRV(DAC2).
 * |        |          |11 = DAC1_IN.
 * |[29:28] |CPPSEL    |Comparator Positive Input Selection
 * |        |          |00 = ACMP1_P0 (PC.0).
 * |        |          |01 = ACMP1_P1 (PC.1).
 * |        |          |10 = ACMP1_P2 (PD.1).
 * |        |          |11 = PGA_CMP.
 ...
 * |[15:4]  |DAC2      |DAC2 Value = AVDD x DAC2[11:0]/4096.
 * |[31]    |DACMODE   |When DAC mode enable, CRV will follow seting value of DAC2.
 * |        |          |CRV voltage = AVDD x DAC2[11:0]/4096.
 * @var ACMP_T::TRGDLY
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:4]  |DAC0      |DAC0 Value = AVDD x DAC1[11:0]/4096.
 * |[31:20] |DAC1      |DAC1 Value = AVDD x DAC1[11:0]/4096.
 */
    __IO uint32_t CTL[2];                /*!< [0x0000] Analog Comparator0 Control Register                              */
    ...
    __IO uint32_t DAC;                   /*!< [0x0014] DAC Register                                                     */
...
#define ACMP_VREF_DAC2_Pos               (4)                                               /*!< ACMP_T::VREF: DAC2 Position            */
#define ACMP_VREF_DAC2_Msk               (0xffful << ACMP_VREF_DAC2_Pos)                   /*!< ACMP_T::VREF: DAC2 Mask                */

#define ACMP_VREF_DACMODE_Pos            (31)                                              /*!< ACMP_T::VREF: DACMODE Position         */
#define ACMP_VREF_DACMODE_Msk            (0x1ul << ACMP_VREF_DACMODE_Pos)                  /*!< ACMP_T::VREF: DACMODE Mask             */
...
#define ACMP_DAC_DAC0_Pos                (4)                                               /*!< ACMP_T::DAC: DAC0 Position             */
#define ACMP_DAC_DAC0_Msk                (0xffful << ACMP_DAC_DAC0_Pos)                    /*!< ACMP_T::DAC: DAC0 Mask                 */

#define ACMP_DAC_DAC1_Pos                (20)                                              /*!< ACMP_T::DAC: DAC1 Position             */
#define ACMP_DAC_DAC1_Msk                (0xffful << ACMP_DAC_DAC1_Pos)                    /*!< ACMP_T::DAC: DAC1 Mask                 */
 ...
 * |        |          |Note: This bit is set to "1" when A/D conversion is completed and cleared by hardware after the ADC_DAT0 register is read.
 ...
 * |        |          |Note1: If converted data in ADC1DAT0[27:16] has not been read before, 
 * |        |          |the new conversion result is loaded to this register, OV is set to "1".
 * |        |          |Note2:It is cleared by hardware after the ADC_DAT0 register is read.
 ...
 * |        |          |Note2: It is cleared by hardware after the ADC_DAT1 register is read.
 * |[15]    |ADC0VALID |ADC0 Valid Flag
 * |        |          |0 = Data in ADC0DAT1[11:0] bits not valid.
 * |        |          |1 = Data in ADC0DAT1[11:0] bits valid.
 * |        |          |Note: This bit is set to "1" when A/D conversion is completed and cleared by hardware after the ADC_DAT1 register is read.
 ...
 * |        |          |Note: This bit is set to "1" when A/D conversion is completed and cleared by hardware after the ADC_DAT1 register is read.
 * @var ADC_T::SECDAT0
 * Offset: 0x08  ADC Data Register 0 for Second Trigger
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |ADC0DAT0  |ADC0 Conversion Result
 ...
 * |        |          |Note: This bit is set to "1" when A/D conversion is completed and cleared by hardware after the ADC_DAT0 register is read.
 * @var ADC_T::SECDAT1
 * Offset: 0x0C  ADC Data Register 1 for Second Trigger
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |ADC0DAT1  |ADC0 Conversion Result for FIFO1
 ...
 * |[4]     |SECTRIEN  |Second Trigger enable
 * |        |          |0 = Disable ADC second trigger function.
 * |        |          |1 = Enable second triger even to trigger ADC.
 ...
 * |        |          |This bit will be cleared to "0" by hardware automatically.
 * |[13:12] |ADC_SPEED |ADC Convertion Rate Select.
 * |        |          |00 = fast convertion rate, but with slow accurate. (< 1us)
 * |        |          |01,10 = middle convertion rate and accurate. (around 1us)
 * |        |          |11 = slow convertion rate, but with high accurate. (1us ~ 1.5us)
 * |[19:16] |ADC0CHSEL |ADC1 Channel Select
 * |        |          |0000 = ADC0_CH0.
 * |        |          |0001 = ADC0_CH1.
 * |        |          |0010 = ADC0_CH2.
 * |        |          |0011 = ADC0_CH3.
 ...
 * |        |          |1110 = ADC0_CH6.
 * |        |          |1111 = ADC0_CH7
 * |[23:20] |ADC0SEQSEL|ADC0 Sequential Input Pin Selection (Second Input)(Only available when ADC_MODE=11)
 * |        |          |0000 = ADC0_CH0.
 * |        |          |0001 = ADC0_CH1.
 * |        |          |0010 = ADC0_CH2.
 * |        |          |0011 = ADC0_CH3.
 ...
 * |        |          |1110 = ADC0_CH6.
 * |        |          |1111 = ADC0_CH7
 * |[27:24] |ADC1CHSEL |ADC1 Channel Select
 * |        |          |0000 = ADC1_CH0.
 * |        |          |0001 = ADC1_CH1.
 * |        |          |0010 = ADC1_CH2.
 * |        |          |0011 = ADC0_CH0.
 ...
 * |        |          |1110 = ADC1_CH6.
 * |        |          |1111 = ADC1_CH7
 * |[31:28] |ADC1SEQSEL|ADC1 Sequential Input Pin Selection (Second Input)(Only available when ADC_MODE=11)
 * |        |          |0000 = ADC1_CH0.
 * |        |          |0001 = ADC1_CH1.
 * |        |          |0010 = ADC1_CH2.
 * |        |          |0011 = ADC0_CH0.
 ...
 * |        |          |11 = Reserved.
 * |[11:8]  |SADC0TRGSOR|ADC0 Trigger Source
 * |        |          |0000 = STADC.
 * |        |          |0001 = PWM0.
 * |        |          |0010 = PWM1.
 * |        |          |0011 = PWM2.
 ...
 * |        |          |1011 = ADC1IF.
 * |        |          |1100~1111 = Reserved.
 * |[13:12] |SADC0PWMTRGSEL|PWM Trigger Selection for ADC0
 * |        |          |00 = EPWM Signal Falling.
 * |        |          |01 = EPWM Counter Central.
 * |        |          |10 = EPWM signal Rising.
 * |        |          |11 = Period.
 * |[15:14] |SADC0STADCSEL|ADC0 External Trigger Pin (STADC) Trigger Selection
 * |        |          |00 = Rising.
 * |        |          |01 = Falling.
 * |        |          |10 = Rising or Falling.
 * |        |          |11 = Reserved.
 ...
 * |        |          |10 = Rising or Falling.
 * |        |          |11 = Reserved.
 * |[27:24] |SADC1TRGSOR|ADC1 Trigger Source
 * |        |          |0000 = STADC.
 * |        |          |0001 = PWM0.
 * |        |          |0010 = PWM1.
 * |        |          |0011 = PWM2.
 ...
 * |        |          |1011 = ADC1IF.
 * |        |          |1100~1111 = Reserved.
 * |[29:28] |SADC1PWMTRGSEL|PWM Trigger Selection for ADC1
 * |        |          |00 = EPWM Signal Falling.
 * |        |          |01 = EPWM Counter Central.
 * |        |          |10 = EPWM signal Rising.
 * |        |          |11 = Period.
 * |[31:30] |SADC1STADCSEL|ADC1 External Trigger Pin (STADC) Trigger Selection
 * |        |          |00 = Rising.
 * |        |          |01 = Falling.
 * |        |          |10 = Rising or Falling.
 * |        |          |11 = Reserved.
 ...
 * |        |          |0 = Conversion result in ADC_DAT0/1 does not meets the WCMPLOWDAT setting.
 * |        |          |1 = Conversion result in ADC_DAT0/1 meets the WCMPLOWDAT setting.
 ...
 * |        |          |Then it is cleared by writing "1" to ifself.
 * |        |          |0 = Conversion result in ADC_DAT0/1 does not meet the WCMPLOWDAT setting.
 * |        |          |1 = Conversion result in ADC_DAT0/1 meets the WCMPLOWDAT setting.
 ...
 * |        |          |Then it is cleared by writing "1" to ifself.
 * |        |          |0 = Conversion result in ADC_DAT0/1 isn't between High Bound (WCMPHIGHDAT) and Low Bound (WCMPLOWDAT).
 * |        |          |1 = Conversion result in ADC_DAT0/1 is between High Bound (WCMPHIGHDAT) and Low Bound (WCMPLOWDAT).
 ...
 * |        |          |Then it is cleared by writing "1" to ifself.
 * |        |          |0 = Conversion result in ADC_DAT0/1 does not meet the WCMPHIGHDAT setting.
 * |        |          |1 = Conversion result in ADC_DAT0/1 meets the WCMPHIGHDAT setting.
 * @var ADC_T::WCMPCTL
 * Offset: 0x34  ADC Window Comparator Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |WCMPEN    |Window Comparator Enable Control
 * |        |          |0 = Window Comparator Disabled.
 * |        |          |1 = Window Comparator Enabled.
 * |[1]     |WCMPIEN   |Window Comparator Interrupt Enable Control
 * |        |          |0 = Window Comparator Interrupt Disabled.
 * |        |          |1 = Window Comparator Interrupt Enabled.
 * |[4]     |WCMPLOWEN |Window Comparator Low Flag Enable Control
 * |        |          |set A/D conversion result lower than compare condition Low bound range
 * |        |          |0 = Window Comparator Low Flag Disabled.
 * |        |          |1 = Window Comparator Low Flag Enabled.
 * |[5]     |WCMPMIDEN |Window Comparator Middle Flag Enable Control
 * |        |          |set A/D conversion result equal to compare condition at Low and High bound range
 * |        |          |0 = Window Comparator Middle Flag Disabled.
 * |        |          |1 = Window Comparator Middle Flag Enabled.
 * |[6]     |WCMPHIGHEN|Window Comparator High Flag Enable Control
 * |        |          |set A/D conversion result higher than compare condition High bound range
 * |        |          |0 = Window Comparator High Flag Disabled.
 * |        |          |1 = Window Comparator High Flag Enabled.
 ...
 * @var ADC_T::WCMPDAT
 * Offset: 0x38  ADC Window Comparator Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 */
    __I  uint32_t DAT0;                  /*!< [0x0000] ADC Data Register 0                                              */
    __I  uint32_t DAT1;                  /*!< [0x0004] ADC Data Register 1                                              */
    __I  uint32_t SECDAT0;               /*!< [0x0008] ADC Data Register 0 for Second Trigger                           */
    __I  uint32_t SECDAT1;               /*!< [0x000c] ADC Data Register 1 for Second Trigger                           */
...
#define ADC_DAT0_ADC0DAT0_Pos            (0)                                               /*!< ADC_T::DAT0: ADC0DAT0 Position         */
#define ADC_DAT0_ADC0DAT0_Msk            (0xffful << ADC_DAT0_ADC0DAT0_Pos)                /*!< ADC_T::DAT0: ADC0DAT0 Mask             */

#define ADC_DAT0_ADC0OV_Pos              (14)                                              /*!< ADC_T::DAT0: ADC0OV Position           */
#define ADC_DAT0_ADC0OV_Msk              (0x1ul << ADC_DAT0_ADC0OV_Pos)                    /*!< ADC_T::DAT0: ADC0OV Mask               */

#define ADC_DAT0_ADC0VALID_Pos           (15)                                              /*!< ADC_T::DAT0: ADC0VALID Position        */
#define ADC_DAT0_ADC0VALID_Msk           (0x1ul << ADC_DAT0_ADC0VALID_Pos)                 /*!< ADC_T::DAT0: ADC0VALID Mask            */

#define ADC_DAT0_ADC1DAT0_Pos            (16)                                              /*!< ADC_T::DAT0: ADC1DAT0 Position         */
#define ADC_DAT0_ADC1DAT0_Msk            (0xffful << ADC_DAT0_ADC1DAT0_Pos)                /*!< ADC_T::DAT0: ADC1DAT0 Mask             */

#define ADC_DAT0_ADC1OV_Pos              (30)                                              /*!< ADC_T::DAT0: ADC1OV Position           */
#define ADC_DAT0_ADC1OV_Msk              (0x1ul << ADC_DAT0_ADC1OV_Pos)                    /*!< ADC_T::DAT0: ADC1OV Mask               */

#define ADC_DAT0_ADC1VALID_Pos           (31)                                              /*!< ADC_T::DAT0: ADC1VALID Position        */
#define ADC_DAT0_ADC1VALID_Msk           (0x1ul << ADC_DAT0_ADC1VALID_Pos)                 /*!< ADC_T::DAT0: ADC1VALID Mask            */

#define ADC_DAT1_ADC0DAT1_Pos            (0)                                               /*!< ADC_T::DAT1: ADC0DAT1 Position         */
#define ADC_DAT1_ADC0DAT1_Msk            (0xffful << ADC_DAT1_ADC0DAT1_Pos)                /*!< ADC_T::DAT1: ADC0DAT1 Mask             */

#define ADC_DAT1_ADC0OV_Pos              (14)                                              /*!< ADC_T::DAT1: ADC0OV Position           */
#define ADC_DAT1_ADC0OV_Msk              (0x1ul << ADC_DAT1_ADC0OV_Pos)                    /*!< ADC_T::DAT1: ADC0OV Mask               */

#define ADC_DAT1_ADC0VALID_Pos           (15)                                              /*!< ADC_T::DAT1: ADC0VALID Position        */
#define ADC_DAT1_ADC0VALID_Msk           (0x1ul << ADC_DAT1_ADC0VALID_Pos)                 /*!< ADC_T::DAT1: ADC0VALID Mask            */

#define ADC_DAT1_ADC1DAT1_Pos            (16)                                              /*!< ADC_T::DAT1: ADC1DAT1 Position         */
#define ADC_DAT1_ADC1DAT1_Msk            (0xffful << ADC_DAT1_ADC1DAT1_Pos)                /*!< ADC_T::DAT1: ADC1DAT1 Mask             */

#define ADC_DAT1_ADC1OV_Pos              (30)                                              /*!< ADC_T::DAT1: ADC1OV Position           */
#define ADC_DAT1_ADC1OV_Msk              (0x1ul << ADC_DAT1_ADC1OV_Pos)                    /*!< ADC_T::DAT1: ADC1OV Mask               */

#define ADC_DAT1_ADC1VALID_Pos           (31)                                              /*!< ADC_T::DAT1: ADC1VALID Position        */
#define ADC_DAT1_ADC1VALID_Msk           (0x1ul << ADC_DAT1_ADC1VALID_Pos)                 /*!< ADC_T::DAT1: ADC1VALID Mask            */

#define ADC_SECDAT0_ADC0DAT0_Pos         (0)                                               /*!< ADC_T::DAT2: ADC0DAT0 Position         */
#define ADC_SECDAT0_ADC0DAT0_Msk         (0xffful << ADC_SECDAT0_ADC0DAT0_Pos)             /*!< ADC_T::DAT2: ADC0DAT0 Mask             */

#define ADC_SECDAT0_ADC0OV_Pos           (14)                                              /*!< ADC_T::DAT2: ADC0OV Position           */
#define ADC_SECDAT0_ADC0OV_Msk           (0x1ul << ADC_SECDAT0_ADC0OV_Pos)                 /*!< ADC_T::DAT2: ADC0OV Mask               */

#define ADC_SECDAT0_ADC0VALID_Pos        (15)                                              /*!< ADC_T::DAT2: ADC0VALID Position        */
#define ADC_SECDAT0_ADC0VALID_Msk        (0x1ul << ADC_SECDAT0_ADC0VALID_Pos)              /*!< ADC_T::DAT2: ADC0VALID Mask            */

#define ADC_SECDAT0_ADC1DAT0_Pos         (16)                                              /*!< ADC_T::DAT2: ADC1DAT0 Position         */
#define ADC_SECDAT0_ADC1DAT0_Msk         (0xffful << ADC_SECDAT0_ADC1DAT0_Pos)             /*!< ADC_T::DAT2: ADC1DAT0 Mask             */

#define ADC_SECDAT0_ADC1OV_Pos           (30)                                              /*!< ADC_T::DAT2: ADC1OV Position           */
#define ADC_SECDAT0_ADC1OV_Msk           (0x1ul << ADC_SECDAT0_ADC1OV_Pos)                 /*!< ADC_T::DAT2: ADC1OV Mask               */

#define ADC_SECDAT0_ADC1VALID_Pos        (31)                                              /*!< ADC_T::DAT2: ADC1VALID Position        */
#define ADC_SECDAT0_ADC1VALID_Msk        (0x1ul << ADC_SECDAT0_ADC1VALID_Pos)              /*!< ADC_T::DAT2: ADC1VALID Mask            */

#define ADC_SECDAT1_ADC0DAT1_Pos         (0)                                               /*!< ADC_T::DAT3: ADC0DAT1 Position         */
#define ADC_SECDAT1_ADC0DAT1_Msk         (0xffful << ADC_SECDAT1_ADC0DAT1_Pos)             /*!< ADC_T::DAT3: ADC0DAT1 Mask             */

#define ADC_SECDAT1_ADC0OV_Pos           (14)                                              /*!< ADC_T::DAT3: ADC0OV Position           */
#define ADC_SECDAT1_ADC0OV_Msk           (0x1ul << ADC_SECDAT1_ADC0OV_Pos)                 /*!< ADC_T::DAT3: ADC0OV Mask               */

#define ADC_SECDAT1_ADC0VALID_Pos        (15)                                              /*!< ADC_T::DAT3: ADC0VALID Position        */
#define ADC_SECDAT1_ADC0VALID_Msk        (0x1ul << ADC_SECDAT1_ADC0VALID_Pos)              /*!< ADC_T::DAT3: ADC0VALID Mask            */

#define ADC_SECDAT1_ADC1DAT1_Pos         (16)                                              /*!< ADC_T::DAT3: ADC1DAT1 Position         */
#define ADC_SECDAT1_ADC1DAT1_Msk         (0xffful << ADC_SECDAT1_ADC1DAT1_Pos)             /*!< ADC_T::DAT3: ADC1DAT1 Mask             */

#define ADC_SECDAT1_ADC1OV_Pos           (30)                                              /*!< ADC_T::DAT3: ADC1OV Position           */
#define ADC_SECDAT1_ADC1OV_Msk           (0x1ul << ADC_SECDAT1_ADC1OV_Pos)                 /*!< ADC_T::DAT3: ADC1OV Mask               */

#define ADC_SECDAT1_ADC1VALID_Pos        (31)                                              /*!< ADC_T::DAT3: ADC1VALID Position        */
#define ADC_SECDAT1_ADC1VALID_Msk        (0x1ul << ADC_SECDAT1_ADC1VALID_Pos)              /*!< ADC_T::DAT3: ADC1VALID Mask            */
...
#define ADC_CTL_SECTRIEN_Pos             (4)                                               /*!< ADC_T::CTL: SECTRIEN Position          */
#define ADC_CTL_SECTRIEN_Msk             (0x1ul << ADC_CTL_SECTRIEN_Pos)                   /*!< ADC_T::CTL: SECTRIEN Mask              */

#define ADC_CTL_ADCSS3R_Pos              (5)                                               /*!< ADC_T::CTL: ADCSS3R Position           */
#define ADC_CTL_ADCSS3R_Msk              (0x1ul << ADC_CTL_ADCSS3R_Pos)                    /*!< ADC_T::CTL: ADCSS3R Mask               */
...
#define ADC_CTL_ADCSPEED_POS             (12)                                              /*!< ADC_T::CTL: ADCSPEED Position          */
#define ADC_CTL_ADCSPEED_MSK             (0x3ul << ADC_CTL_ADCSPEED_POS)                   /*!< ADC_T::CTL: ADCSPEED Mask              */

#define ADC_CTL_ADC0CHSEL_Pos            (16)                                              /*!< ADC_T::CTL: ADC0CHSEL Position         */
#define ADC_CTL_ADC0CHSEL_Msk            (0xful << ADC_CTL_ADC0CHSEL_Pos)                  /*!< ADC_T::CTL: ADC0CHSEL Mask             */

#define ADC_CTL_ADC0SEQSEL_Pos           (20)                                              /*!< ADC_T::CTL: ADC0SEQSEL Position        */
#define ADC_CTL_ADC0SEQSEL_Msk           (0xful << ADC_CTL_ADC0SEQSEL_Pos)                 /*!< ADC_T::CTL: ADC0SEQSEL Mask            */

#define ADC_CTL_ADC1CHSEL_Pos            (24)                                              /*!< ADC_T::CTL: ADC1CHSEL Position         */
#define ADC_CTL_ADC1CHSEL_Msk            (0xful << ADC_CTL_ADC1CHSEL_Pos)                  /*!< ADC_T::CTL: ADC1CHSEL Mask             */

#define ADC_CTL_ADC1SEQSEL_Pos           (28)                                              /*!< ADC_T::CTL: ADC1SEQSEL Position        */
#define ADC_CTL_ADC1SEQSEL_Msk           (0xful << ADC_CTL_ADC1SEQSEL_Pos)                 /*!< ADC_T::CTL: ADC1SEQSEL Mask            */
...
#define ADC_TRGSOR_SADC0TRGSOR_Pos       (8)                                               /*!< ADC_T::TRGSOR: SADC0TRGSOR Position    */
#define ADC_TRGSOR_SADC0TRGSOR_Msk       (0xful << ADC_TRGSOR_SADC0TRGSOR_Pos)             /*!< ADC_T::TRGSOR: SADC0TRGSOR Mask        */

#define ADC_TRGSOR_SADC0PWMTRGSEL_Pos    (12)                                              /*!< ADC_T::TRGSOR: SADC0PWMTRGSEL Position */
#define ADC_TRGSOR_SADC0PWMTRGSEL_Msk    (0x3ul << ADC_TRGSOR_SADC0PWMTRGSEL_Pos)          /*!< ADC_T::TRGSOR: SADC0PWMTRGSEL Mask     */

#define ADC_TRGSOR_SADC0STADCSEL_Pos     (14)                                              /*!< ADC_T::TRGSOR: SADC0STADCSEL Position  */
#define ADC_TRGSOR_SADC0STADCSEL_Msk     (0x3ul << ADC_TRGSOR_SADC0STADCSEL_Pos)           /*!< ADC_T::TRGSOR: SADC0STADCSEL Mask      */
...
#define ADC_TRGSOR_SADC1PWMTRGSEL_Pos    (28)                                              /*!< ADC_T::TRGSOR: SADC1PWMTRGSEL Position */
#define ADC_TRGSOR_SADC1PWMTRGSEL_Msk    (0x3ul << ADC_TRGSOR_SADC1PWMTRGSEL_Pos)          /*!< ADC_T::TRGSOR: SADC1PWMTRGSEL Mask     */

#define ADC_TRGSOR_SADC1STADCSEL_Pos     (30)                                              /*!< ADC_T::TRGSOR: SADC1STADCSEL Position  */
#define ADC_TRGSOR_SADC1STADCSEL_Msk     (0x3ul << ADC_TRGSOR_SADC1STADCSEL_Pos)           /*!< ADC_T::TRGSOR: SADC1STADCSEL Mask      */
...
#define ADC_STATUS_ADC0OV_Pos            (1)                                               /*!< ADC_T::STATUS: ADC0OV Position         */
#define ADC_STATUS_ADC0OV_Msk            (0x1ul << ADC_STATUS_ADC0OV_Pos)                  /*!< ADC_T::STATUS: ADC0OV Mask             */
...
#define ADC_STATUS_ADC1OV_Pos            (9)                                               /*!< ADC_T::STATUS: ADC1OV Position         */
#define ADC_STATUS_ADC1OV_Msk            (0x1ul << ADC_STATUS_ADC1OV_Pos)                  /*!< ADC_T::STATUS: ADC1OV Mask             */
...
#define ADC_STATUS_WCMPIF_Pos            (16)                                              /*!< ADC_T::STATUS: WCMPIF Position         */
#define ADC_STATUS_WCMPIF_Msk            (0x1ul << ADC_STATUS_WCMPIF_Pos)                  /*!< ADC_T::STATUS: WCMPIF Mask             */

#define ADC_STATUS_LOWFG_Pos             (17)                                              /*!< ADC_T::STATUS: LOWFG Position          */
#define ADC_STATUS_LOWFG_Msk             (0x1ul << ADC_STATUS_LOWFG_Pos)                   /*!< ADC_T::STATUS: LOWFG Mask              */

#define ADC_STATUS_MIDFG_Pos             (18)                                              /*!< ADC_T::STATUS: MIDFG Position          */
#define ADC_STATUS_MIDFG_Msk             (0x1ul << ADC_STATUS_MIDFG_Pos)                   /*!< ADC_T::STATUS: MIDFG Mask              */

#define ADC_STATUS_HIGHFG_Pos            (19)                                              /*!< ADC_T::STATUS: HIGHFG Position         */
#define ADC_STATUS_HIGHFG_Msk            (0x1ul << ADC_STATUS_HIGHFG_Pos)                  /*!< ADC_T::STATUS: HIGHFG Mask             */

#define ADC_WCMPCTL_WCMPEN_Pos           (0)                                               /*!< ADC_T::WCMPCTL: WCMPEN Position        */
#define ADC_WCMPCTL_WCMPEN_Msk           (0x1ul << ADC_WCMPCTL_WCMPEN_Pos)                 /*!< ADC_T::WCMPCTL: WCMPEN Mask            */

#define ADC_WCMPCTL_WCMPIEN_Pos          (1)                                               /*!< ADC_T::WCMPCTL: WCMPIEN Position       */
#define ADC_WCMPCTL_WCMPIEN_Msk          (0x1ul << ADC_WCMPCTL_WCMPIEN_Pos)                /*!< ADC_T::WCMPCTL: WCMPIEN Mask           */

#define ADC_WCMPCTL_WCMPLOWEN_Pos        (4)                                               /*!< ADC_T::WCMPCTL: WCMPLOWEN Position     */
#define ADC_WCMPCTL_WCMPLOWEN_Msk        (0x1ul << ADC_WCMPCTL_WCMPLOWEN_Pos)              /*!< ADC_T::WCMPCTL: WCMPLOWEN Mask         */

#define ADC_WCMPCTL_WCMPMIDEN_Pos        (5)                                               /*!< ADC_T::WCMPCTL: WCMPMIDEN Position     */
#define ADC_WCMPCTL_WCMPMIDEN_Msk        (0x1ul << ADC_WCMPCTL_WCMPMIDEN_Pos)              /*!< ADC_T::WCMPCTL: WCMPMIDEN Mask         */

#define ADC_WCMPCTL_WCMPHIGHEN_Pos       (6)                                               /*!< ADC_T::WCMPCTL: WCMPHIGHEN Position    */
#define ADC_WCMPCTL_WCMPHIGHEN_Msk       (0x1ul << ADC_WCMPCTL_WCMPHIGHEN_Pos)             /*!< ADC_T::WCMPCTL: WCMPHIGHEN Mask        */

#define ADC_WCMPCTL_WFLAGCTL_Pos         (7)                                               /*!< ADC_T::WCMPCTL: WFLAGCTL Position      */
#define ADC_WCMPCTL_WFLAGCTL_Msk         (0x1ul << ADC_WCMPCTL_WFLAGCTL_Pos)               /*!< ADC_T::WCMPCTL: WFLAGCTL Mask          */

#define ADC_WCMPCTL_WCMPMCNT_Pos         (8)                                               /*!< ADC_T::WCMPCTL: WCMPMCNT Position      */
#define ADC_WCMPCTL_WCMPMCNT_Msk         (0xful << ADC_WCMPCTL_WCMPMCNT_Pos)               /*!< ADC_T::WCMPCTL: WCMPMCNT Mask          */

#define ADC_WCMPDAT_WCMPLOWDAT_Pos       (0)                                               /*!< ADC_T::WCMPDAT: WCMPLOWDAT Position    */
#define ADC_WCMPDAT_WCMPLOWDAT_Msk       (0xffful << ADC_WCMPDAT_WCMPLOWDAT_Pos)           /*!< ADC_T::WCMPDAT: WCMPLOWDAT Mask        */

#define ADC_WCMPDAT_WCMPHIGHDAT_Pos      (16)                                              /*!< ADC_T::WCMPDAT: WCMPHIGHDAT Position   */
#define ADC_WCMPDAT_WCMPHIGHDAT_Msk      (0xffful << ADC_WCMPDAT_WCMPHIGHDAT_Pos)          /*!< ADC_T::WCMPDAT: WCMPHIGHDAT Mask       */
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[15]    |NUUEN     |NUROM Update Enable Control (Write Protect)
 * |        |          |0 = NUROM cannot be updated.
 * |        |          |1 = NUROM can be updated when the MCU runs in APROM.
 * @var FMC_T::ISPADDR
 ...
 * |        |          |The NM1230 series supports word program only. ISPADR[1:0] must be kept 00 for ISP operation.
 * @var FMC_T::ISPDAT
...
#define FMC_ISPCTL_NUUEN_Pos             (15)                                              /*!< FMC_T::ISPCTL: NUUEN Position          */
#define FMC_ISPCTL_NUUEN_Msk             (0x1ul << FMC_ISPCTL_NUUEN_Pos)                   /*!< FMC_T::ISPCTL: NUUEN Mask              */
...
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[0]     |PGAEN     |Programmable Gain Amplifier Enable Control
...
* |        |          |110 = 13.
* |        |          |111 = 1 . (*See Note)
* |[25:24] |PGA_CHSEL |00: PGA source setect to PGA_IN pad
* |        |          |01: PGA source setect to DAC0
* |        |          |10: PGA source setect to DAC1
* @var PGA_T::OP_CTL
* Offset: 0x04  Output Amplifier Control Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[0]     |OP0EN     |Output Amplifier0 Enable Control
* |        |          |0 = Amplifier Disabled.
* |        |          |1 = Amplifier Enabled.
* |[1]     |OP1EN     |Output Amplifier1 Enable Control
* |        |          |0 = Amplifier Disabled.
* |        |          |1 = Amplifier Enabled.
* |[2]     |OP2EN     |Output Amplifier2 Enable Control
* |        |          |0 = Amplifier Disabled.
* |        |          |1 = Amplifier Enabled.
*/
    __IO uint32_t CTL;                   /*!< [0x0000] Programmable Gain Amplifier Control Register                     */    
    __IO uint32_t OP_CTL;                /*!< [0x0004] Output Amplifier Control Register                                */
...
#define PGA_CTL_PGAEN_Pos                (0)                                               /*!< PGA_T::CTL: PGAEN Position             */
#define PGA_CTL_PGAEN_Msk                (0x1ul << PGA_CTL_PGAEN_Pos)                      /*!< PGA_T::CTL: PGAEN Mask                 */

#define PGA_CTL_GAIN_Pos                 (4)                                               /*!< PGA_T::CTL: GAIN Position              */
#define PGA_CTL_GAIN_Msk                 (0x7ul << PGA_CTL_GAIN_Pos)                       /*!< PGA_T::CTL: GAIN Mask                  */

#define PGA_CTL_PGA_CHSEL_Pos            (24)                                              /*!< PGA_T::CTL: PGA_CHSEL Position         */
#define PGA_CTL_PGA_CHSEL_Msk            (0x3ul << PGA_CTL_PGA_CHSEL_Pos)                  /*!< PGA_T::CTL: PGA_CHSEL Mask             */

#define PGA_CTL_OP_CTL_OP0EN_Pos         (0)                                               /*!< PGA_T::OP_CTL: OP0EN Position          */
#define PGA_CTL_OP_CTL_OP0EN_Msk         (0x1ul << PGA_CTL_OP_CTL_OP0EN_Pos)               /*!< PGA_T::OP_CTL: OP0EN Mask              */

#define PGA_CTL_OP_CTL_OP1EN_Pos         (1)                                               /*!< PGA_T::OP_CTL: OP1EN Position          */
#define PGA_CTL_OP_CTL_OP1EN_Msk         (0x1ul << PGA_CTL_OP_CTL_OP1EN_Pos)               /*!< PGA_T::OP_CTL: OP1EN Mask              */

#define PGA_CTL_OP_CTL_OP2EN_Pos         (2)                                               /*!< PGA_T::OP_CTL: OP2EN Position          */
#define PGA_CTL_OP_CTL_OP2EN_Msk         (0x1ul << PGA_CTL_OP_CTL_OP2EN_Pos)               /*!< PGA_T::OP_CTL: OP2EN Mask              */
 ...
 * |        |          |If the QEI controller is in the compare-counting mode CMPEN (QEI_CTL[28]) =1, when the value of QEI_CNT matches the value of VAL the bit CMPF will be set
 ...
 * |        |          |When this bit is high and a rising edge comes on signal CHX, the QEI_CNT will be reset to zero if the counter is in up-counting type (DIRF = 1); while the QEI_CNT will be reloaded with QEI_CNTMAX content if the counter is in down-counting type (DIRF = 0).
 * |        |          |0 = Reload function Disabled.
 ...
 * |        |          |Similarly, the flag is set wile QEI counter underflows from zero to 0xFFFF_FFFF or QEI_CNTMAX.
 ...
 */
    __IO uint32_t CNT;                   /*!< [0x0000] QEI Pulse Counter Register                                       */
    __IO uint32_t CNTHOLD;               /*!< [0x0004] QEI Pulse Counter Hold Register                                  */
    __IO uint32_t CNTLATCH;              /*!< [0x0008] QEI Pulse Counter Index Latch Register                           */
    __IO uint32_t CNTCMP;                /*!< [0x000c] QEI Pulse Counter Compare Register                               */
    __I  uint32_t RESERVE0[1];
...
#define CRC16_BASE           (AHB_BASE       + 0x14080)                 /*!< CRC16 Base Address                                */
...
#define TIMER3_BASE          (APB1_BASE      + 0x100A0)                 /*!< Timer3 Base Address                               */
...
#define QEI_BASE             (APB2_BASE      + 0xC0000)                 /*!< QEI Base Address                                  */
...
#define CRC16               ((CRC16_T *) CRC16_BASE)                     /*!< CRC16 Configuration Struct                       */
...
#define TIMER3              ((TIMER_T *) TIMER3_BASE)                   /*!< Timer1 Configuration Struct                      */
...
#define QEI                 ((QEI_T *) QEI_BASE)                       /*!< QEI Configuration Struct                        */
