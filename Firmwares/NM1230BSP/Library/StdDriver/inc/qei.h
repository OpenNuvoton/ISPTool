 ...
 * @brief    NM1230 QEI driver header file
 *
 * @note
...
/** @addtogroup NM1230_QEI_EXPORTED_CONSTANTS QEI Exported Constants
  @{
*/
...
#define QEI_CTL_NFCLKSEL_DIV8		(0x3<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK/8 \hideinitializer */
#define QEI_CTL_NFCLKSEL_DIV16   (0x4<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK/16 \hideinitializer */
#define QEI_CTL_NFCLKSEL_DIV32	(0x5<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK/32 \hideinitializer */
#define QEI_CTL_NFCLKSEL_DIV64	(0x6<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK/64 \hideinitializer */
#define QEI_CTL_NFCLKSEL_DIV128	(0x7<<QEI_CTL_NFCLKSEL_Pos) /*!< The sampling frequency of the noise filter is QEI_CLK/128 \hideinitializer */





/*@}*/ /* end of group NM1230_QEI_EXPORTED_CONSTANTS */
