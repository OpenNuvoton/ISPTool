 ...
 * @brief    NM1230 series GPIO driver header file
 *
 * @note
...
/** @addtogroup NM1230_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1230_GPIO_EXPORTED_CONSTANTS */
