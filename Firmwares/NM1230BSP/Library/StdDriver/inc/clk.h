 ...
 * @brief    NM1230 CLK driver header file
 *
 * @note
...
/** @addtogroup NM1230_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup NM1230_CLK_EXPORTED_CONSTANTS CLK Exported Constants
@{
*/
#define FREQ_72MHZ              72000000    /*!< The frequency for 72MHz     */
...
#define CLK_TMR3_SRC_EXT            (0x00UL<<CLK_CLKSEL1_TMR3SEL_Pos)   /*!< Select Timer3 clock source from external crystal    */
#define CLK_TMR3_SRC_LIRC           (0x01UL<<CLK_CLKSEL1_TMR3SEL_Pos)   /*!< Select Timer3 clock source from LIRC                */
#define CLK_TMR3_SRC_HCLK           (0x02UL<<CLK_CLKSEL1_TMR3SEL_Pos)   /*!< Select Timer3 clock source from HCLK                */
#define CLK_TMR3_SRC_T1             (0x03UL<<CLK_CLKSEL1_TMR3SEL_Pos)   /*!< Select Timer3 clock source from T1                  */
#define CLK_TMR3_SRC_HIRC           (0x07UL<<CLK_CLKSEL1_TMR3SEL_Pos)   /*!< Select Timer3 clock source from HIRC                */

#define CLK_TMR2_SRC_EXT            (0x00UL<<CLK_CLKSEL1_TMR2SEL_Pos)   /*!< Select Timer2 clock source from external crystal    */
...
#define CLK_TMR2_SRC_HIRC           (0x07UL<<CLK_CLKSEL1_TMR2SEL_Pos)   /*!< Select Timer2 clock source from HIRC                */
...
#define CLK_ADC_SRC_EXT             (0x00UL<<CLK_CLKSEL1_ADCSEL_Pos)    /*!< Select ADC clock source from external crystal   */
#define CLK_ADC_SRC_HCLK            (0x02UL<<CLK_CLKSEL1_ADCSEL_Pos)    /*!< Select ADC clock source from HCLK               */
#define CLK_ADC_SRC_HIRC            (0x03UL<<CLK_CLKSEL1_ADCSEL_Pos)    /*!< Select ADC clock source from HIRC               */
...
#define CLK_CLKDIV_ADC(x)          (((x)-1) << CLK_CLKDIV_ADCDIV_Pos)   /*!< CLKDIV Setting for ADC clock divider. It could be 1~256  */
...
#define CRC16_MODULE ((0UL<<30)|(MODULE_NoMsk<<27)|(MODULE_NoMsk<<22)    |(           MODULE_NoMsk<<17)|(MODULE_NoMsk<<14)|(MODULE_NoMsk<<10)    |(         MODULE_NoMsk<<5)|CLK_AHBCLK_CRC16CKEN_Pos)  /*!< CRC16 Module     */
...
#define TMR3_MODULE  ((1UL<<30)|(           1<<27)|(           3<<22)    |(CLK_CLKSEL1_TMR3SEL_Pos<<17)|(MODULE_NoMsk<<14)|(MODULE_NoMsk<<10)    |(         MODULE_NoMsk<<5)|CLK_APBCLK_TMR3CKEN_Pos)   /*!< TMR3 Module     */
...
#define QEI_MODULE   ((1UL<<30)|(MODULE_NoMsk<<27)|(MODULE_NoMsk<<22)    |(           MODULE_NoMsk<<17)|(MODULE_NoMsk<<14)|(MODULE_NoMsk<<10)    |(         MODULE_NoMsk<<5)|CLK_APBCLK_QEICKEN_Pos)    /*!< QEI Module      */
...
/*@}*/ /* end of group NM1230_CLK_EXPORTED_CONSTANTS */

/** @addtogroup NM1230_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/*@}*/ /* end of group NM1230_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1230_CLK_Driver */
