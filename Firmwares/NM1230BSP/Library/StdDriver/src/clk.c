 ...
 * @brief    NM1230 CLK driver source file
 *
 * @note
...
/**
  ...
  *             The PCLK is always same to HCLK in NM1230.
  */
...
/**
  ...
  * |\ref ISP_MODULE        | x                                 | x                         |
  * |\ref ACMP_MODULE       | x                                 | x                         |
  * |\ref ADC_MODULE        |\ref CLK_ADC_SRC_EXT               |\ref CLK_CLKDIV_ADC(x)     |
  * |\ref ADC_MODULE        |\ref CLK_ADC_SRC_HCLK              |\ref CLK_CLKDIV_ADC(x)     |
  * |\ref ADC_MODULE        |\ref CLK_ADC_SRC_HIRC              |\ref CLK_CLKDIV_ADC(x)     |
  ...
  * |\ref TMR3_MODULE       |\ref CLK_TMR3_SRC_EXT              | x                         |
  * |\ref TMR3_MODULE       |\ref CLK_TMR3_SRC_LIRC             | x                         |
  * |\ref TMR3_MODULE       |\ref CLK_TMR3_SRC_HCLK             | x                         |
  * |\ref TMR3_MODULE       |\ref CLK_TMR3_SRC_T1               | x                         |
  * |\ref TMR3_MODULE       |\ref CLK_TMR3_SRC_HIRC             | x                         |
...
void CLK_SysTickDelay(uint32_t us)
{
    ...
    if (delay_tick > SysTick_LOAD_RELOAD_Msk)   /* SysTick_LOAD_RELOAD_Msk is 24 bits for NM1230 */
    {
