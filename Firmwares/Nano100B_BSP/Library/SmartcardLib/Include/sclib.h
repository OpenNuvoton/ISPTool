...
/** @addtogroup NANO100_SCLIB Smartcard Library
  @{
*/

/** @addtogroup NANO100_SCLIB_EXPORTED_CONSTANTS Smartcard Library Exported Constants
  @{
*/
...
#define SCLIB_ERR_CMD                           0x00000006  ///< Smartcard command error
#define SCLIB_ERR_UNSUPPORTEDCARD               0x00000007  ///< Unsupported smartcard error
...
#define SCLIB_ERR_BGTIMEOUT                     0x0000000E  ///< Block time out error occur
...
#define SCLIB_ERR_PPS                           0x00001004  ///< Protocol Parameter Selection (PPS) exchange error
...
/**
  ...
  * @note Application should call this API after SC_Open() and SC interrupt enabled
  */
...
/*@}*/ /* end of group NANO100_SCLIB_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO100_SC_Library */
