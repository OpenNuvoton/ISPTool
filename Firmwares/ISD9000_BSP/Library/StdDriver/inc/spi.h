 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 15/11/09 02:16p $
 * @brief    ISD9000 SPI driver header file
 *
 * @note
...
/** @addtogroup ISD9000_SPI_Driver SPI Driver
  @{
*/

/** @addtogroup ISD9000_SPI_EXPORTED_CONSTANTS SPI Exported Constants
  @{
*/
...
#define SPI_MODE_2            (SPI_CTL_CLKP_Msk | SPI_CTL_RXNEG_Msk)      /*!< CLKP=1; RX_NEG=1; TX_NEG=0 \hideinitializer */
#define SPI_MODE_3            (SPI_CTL_CLKP_Msk | SPI_CTL_TXNEG_Msk)      /*!< CLKP=1; RX_NEG=0; TX_NEG=1 \hideinitializer */
...
/*@}*/ /* end of group ISD9000_SPI_EXPORTED_CONSTANTS */

/** @addtogroup ISD9000_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9000_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9000_SPI_Driver */
