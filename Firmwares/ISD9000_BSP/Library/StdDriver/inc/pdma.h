 ...
 * $Revision: 1 $
 * $Date: 14/07/15 2:52p $
 * @brief    ISD9000 Series PDMA Controller Driver Header File
 *
 * @note
...
/** @addtogroup ISD9000_PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
...
#define PDMA_SPIM_TX        0x00000002UL            /*!<DMA Connect to SPIM TX */
#define PDMA_SPIM_RX        0x00000003UL            /*!<DMA Connect to SPIM RX */
#define PDMA_ADC            0x00000004UL            /*!<DMA Connect to ADC */
#define PDMA_DPWM           0x00000005UL            /*!<DMA Connect to DPWM */
...
/*@}*/ /* end of group ISD9000_PDMA_EXPORTED_CONSTANTS */
