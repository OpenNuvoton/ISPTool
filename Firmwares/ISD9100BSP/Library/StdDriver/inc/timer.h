 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 14/06/27 11:00a $
 * @brief    ISD9100 TIMER driver header file
 *
 * @note
...
/** @addtogroup ISD9100_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_TIMER_EXPORTED_CONSTANTS */
