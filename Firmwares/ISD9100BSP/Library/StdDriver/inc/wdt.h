 ...
 * $Revision: 3 $
 * $Date: 14/07/15 5:00p $
 * @brief    ISD9100 WDT driver header file
 *
 * @note
...
/** @addtogroup ISD9100_WDT_Driver WDT Driver
  @{
*/


/** @addtogroup ISD9100_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_WDT_EXPORTED_CONSTANTS */


/** @addtogroup ISD9100_WDT_EXPORTED_FUNCTIONS WDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9100_WDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9100_WDT_Driver */
