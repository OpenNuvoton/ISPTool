 ...
 * $Revision: 1 $
 * $Date: 14/07/15 2:52p $
 * @brief    ISD9100 series PWM driver header file
 *
 * @note
...
/** @addtogroup ISD9100_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup ISD9100_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_PWM_EXPORTED_CONSTANTS */


/** @addtogroup ISD9100_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9100_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9100_PWM_Driver */
