 ...
 * $Revision: 1 $
 * $Date: 14/07/15 2:52p $
 * @brief    ISD9100 GPIO driver header file
 *
 * @note
...
/** @addtogroup ISD9100_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup ISD9100_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_GPIO_EXPORTED_CONSTANTS */

/** @addtogroup ISD9100_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
...
/*@}*/ /* end of group ISD9100_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group ISD9100_GPIO_Driver */
