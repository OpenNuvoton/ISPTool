 ...
 * $Revision: 1 $
 * $Date: 14/07/15 2:52p $
 * @brief    ISD9100 Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup ISD9100_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
...
/*@}*/ /* end of group ISD9100_FMC_EXPORTED_CONSTANTS */
